...
- **Origin** says where a decision came from: *Founding brief*, *Foundation closure brief*, *Embodiment and systems brief*, *World foundation brief*, *Environment v0 brief*, *Strategic rooting brief*, *Interaction boundary brief*, *Condition v0 brief*, *Life cycle and anchors brief*, *Warden progression brief*, *State machine brief*, *Harm and maturity brief*, *Manifestation boundary brief*, *Maturity v0 brief*, *Biology-magic boundary brief*, *Pathological impact brief*, *Tuber-funded routing brief*, *Plant autonomy and astral leverage brief*, *Functional collapse boundary brief* or *Terminal embodiment brief* (set by the project owner), or *…, derived* (a conservative consequence worked out in that session).
...
| AMO-D119 | Astral-state damage and biological persistence are not yet mapped | ACCEPTED |
