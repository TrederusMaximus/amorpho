...
- **Origin** says where a decision came from: *Founding brief*, *Foundation closure brief*, *Embodiment and systems brief*, *World foundation brief*, *Environment v0 brief*, *Strategic rooting brief*, *Interaction boundary brief*, *Condition v0 brief*, *Life cycle and anchors brief*, *Warden progression brief*, *State machine brief*, *Harm and maturity brief*, *Manifestation boundary brief*, *Maturity v0 brief*, *Biology-magic boundary brief*, *Pathological impact brief*, *Tuber-funded routing brief*, *Plant autonomy and astral leverage brief*, *Functional collapse boundary brief*, *Terminal embodiment brief*, *Combat body damage brief*, *Combat resolution brief*, *Manifestation destruction brief*, *Productive return brief*, *Recovery ceiling brief*, *Bloom core security brief*, *World time brief* or *Persistent harm boundary brief* (set by the project owner), or *…, derived* (a conservative consequence worked out in that session).
...
| AMO-D098 | Autonomous biological routing serves the individual's own continuation | ACCEPTED |
...
| AMO-D114 | Functional Collapse is loss of active-Leaf role viability | ACCEPTED |
| AMO-D115 | Collapse Commitment is irreversible and ends the Leaf manifestation | ACCEPTED |
| AMO-D116 | Biological recoverability and astral inhabitability are separate dimensions | ACCEPTED |
| AMO-D117 | Embodiment suspends terminal progression without changing terminal fate | ACCEPTED |
| AMO-D118 | Embodiment ends with the manifestation; the consciousness returns to the human | ACCEPTED |
| AMO-D119 | Astral-state damage and biological persistence are not yet mapped | SUPERSEDED |
| AMO-D120 | The inhabited Amorpho's body is the biological manifestation; damage reaching it is biological | ACCEPTED |
| AMO-D121 | Combat state and biological manifestation condition are distinct but coupled | ACCEPTED |
| AMO-D122 | Protection stands between hostile effects and the biological body | ACCEPTED |
| AMO-D123 | Biological progression pauses during embodiment; the body is not invulnerable | ACCEPTED |
| AMO-D124 | An encounter resolves the conflict; it does not require destroying a manifestation | ACCEPTED |
| AMO-D125 | Four resolution families: surrender, escape, conscious withdrawal, objective resolution | ACCEPTED |
| AMO-D126 | The end of an encounter is not the end of embodiment | ACCEPTED |
| AMO-D127 | Fighting to manifestation destruction is permitted escalation, never the default | ACCEPTED |
| AMO-D128 | Encounter resolution does not resolve the conflict; conflict identity follows the Warden | ACCEPTED |
| AMO-D129 | The persistent Tuber travels inside the embodied Amorpho as its central core | ACCEPTED |
| AMO-D130 | Manifestation destruction exposes the actual Tuber where it fell; nothing respawns | ACCEPTED |
| AMO-D131 | Survival after destruction depends on Tuber Core Viability | ACCEPTED |
| AMO-D132 | The Astral Anchor travels with the core and may outlive the individual | ACCEPTED |
| AMO-D133 | Embodiment eligibility and deployment risk are separate questions | ACCEPTED |
| AMO-D134 | One manifestation body across modes; appearance is not a proxy for core condition | ACCEPTED |
| AMO-D135 | Active Leaf Productive Return: biological work that may alter persistent Tuber state | ACCEPTED |
| AMO-D136 | Embodiment suspends ordinary Productive Return | ACCEPTED |
| AMO-D137 | Realized Productive Return survives later manifestation loss | ACCEPTED |
| AMO-D138 | Insufficient return is not pathology; return and pathology are orthogonal | ACCEPTED |
| AMO-D139 | Mature recovery reorganizes surviving architecture; it never reconstructs what was lost | ACCEPTED |
| AMO-D140 | Functional Recovery may be substantial despite permanent structural loss | ACCEPTED |
| AMO-D141 | Recovery Ceiling: what this manifestation could still regain, and damage lowers it | ACCEPTED |
| AMO-D142 | Bloom existence is evidence of substantial prior persistent capability | ACCEPTED |
| AMO-D143 | Bloom embodiment carries the same physical core; destruction exposes the actual Tuber | ACCEPTED |
| AMO-D144 | Bloom raises core-security confidence without guaranteeing current viability | ACCEPTED |
| AMO-D145 | Seasonal opportunity may pass while biology is paused; missed opportunity is not banked | ACCEPTED |
| AMO-D146 | Environmental suitability and intrinsic lifecycle permission are separate | ACCEPTED |
| AMO-D147 | Species shapes lifecycle strategy; the individual owns current lifecycle state | ACCEPTED |
| AMO-D148 | Ordinary depletion, legitimate expenditure and missed gain are not pathology | ACCEPTED |
| AMO-D149 | Persistent harm requires actual degradation of persistence, and survives turnover | ACCEPTED |
| AMO-D150 | Replenishment of capacity and repair of persistent harm are separate processes | ACCEPTED |
| AMO-D151 | Core Viability and pathology are separate derived dimensions | ACCEPTED |
...
- **Revised:** 2026-09-23, manifestation destruction brief — an embodied Amorpho **carries its own attached Anchor** with the persistent core as it moves, and that is not attaching, removing, transferring or reconfiguring one (AMO-D129, AMO-D132). The rule governs **which individuals are anchored**, which still requires human hands. Substance unchanged.
...
- **Revised:** 2026-09-23, combat body damage brief — suspension covers **ordinary progression** (growth, development, maturity, reproduction, life-cycle progression, Programmed Draw, recovery) and resource consumption. It is **not** invulnerability: the animated body is the biological manifestation, and explicit injury reaching it is a state change that damages it while paused (AMO-D120, AMO-D123). Substance unchanged.
...
## AMO-D098 — Autonomous biological routing serves the individual's own continuation

- **Status:** ACCEPTED · **Date:** 2026-09-22 · **Origin:** Plant autonomy and astral leverage brief
- **Decision:** When no Warden intervention reaches a biological routing point, the individual's own biology selects among the feasible routes, and it selects for **its own long-term biological viability and future developmental and reproductive potential** — not the player's combat needs, travel plans, desire for another playable body, entertainment value or asset protection. The selection is **environment-aware** (current Environmental Fit and trajectory, Remaining Productive Opportunity, Tuber condition, reserves, current manifestation state) and works from **currently available biological state, not perfect foresight**.
- **Rationale:** The World persists independently of players, and an unattended individual must still route (AMO-D009, AMO-D097, L7). Left without a stated objective, "autonomous" would silently become either a game director tuning difficulty or a coin flip; both make biology decorative.
- **Consequences:** **Declining an affordable replacement is a legitimate outcome**, not a simulation failure — conserving capacity for a later cycle may be the best available strategy (AMO-D096, AMO-Q087). Autonomy is **plant-protective, not player-punitive**, and is not promised to be optimal: imperfect information may produce a route that turns out badly. **Not anthropomorphic** — no personality, mood, happiness state, consent or preference meter, and **no AI technology is chosen** (no behaviour tree, utility AI, GOAP or learned model). A future model may express tendency as probability, weighted propensity, deterministic utility or a hybrid, but any variability must be **biologically conditioned**: a fixed state-independent split such as *half replace, half retreat* is forbidden. No percentage, weight, curve, roll or information model is defined (AMO-Q101, AMO-Q075, [26_PLANT_AUTONOMY_ASTRAL_LEVERAGE_AND_ROUTING_V0.md](26_PLANT_AUTONOMY_ASTRAL_LEVERAGE_AND_ROUTING_V0.md)).

## AMO-D099 — Astral reachability is not playability; the Astral Window closes at Deep Dormancy

- **Status:** ACCEPTED · **Date:** 2026-09-22 · **Origin:** Plant autonomy and astral leverage brief
- **Decision:** A persistent Tuber with no viable playable manifestation may remain **astrally reachable** for a transitional biological period — the **Astral Window** — during which its Astral Signal is present and a Warden may establish direct astral presence with the individual. **Reachability is not inhabitability**: the Tuber never becomes a playable locomotion or combat body (AMO-D089). The purpose of presence during the window is influence over a biologically available routing decision, nothing else. **Deep Dormancy closes the window** — Astral Silence, no entry, no strategic influence — and a route already executed is never rewritten retroactively.
- **Rationale:** This names structure the architecture already had: transitional access narrowing to a closed floor (AMO-D070) and the independent Astral Signal curve fading to silence (AMO-D088). It gives intervention a real deadline that is biologically caused, without a countdown interface and without the World waiting for an owner.
- **Consequences:** No Tuber locomotion, combat or exploration may be introduced under this concept, and playable embodiment resumes only once a suitable manifestation exists and passes the ordinary gates including Astral Readiness (AMO-D063, AMO-D086). Because no manifestation is animated during the window, nothing runs on magical state and embodiment's suspension of biology does not apply (AMO-D084) — the individual's biology continues, which is why the window can close while the Warden is present. The window's **duration is biological and state-dependent**; no span, boundary point, warning, radar display or connection mechanic is defined (AMO-Q085, AMO-Q092, AMO-Q112, AMO-Q115, AMO-Q119). No `WAITING_FOR_PLAYER` state exists ([26_PLANT_AUTONOMY_ASTRAL_LEVERAGE_AND_ROUTING_V0.md](26_PLANT_AUTONOMY_ASTRAL_LEVERAGE_AND_ROUTING_V0.md)).

## AMO-D100 — Astral leverage selects among feasible routes and pays their full cost

- **Status:** ACCEPTED · **Date:** 2026-09-22 · **Origin:** Plant autonomy and astral leverage brief
- **Decision:** A Warden with direct astral presence at a routing point may select any **biologically feasible** route, **including one the plant's autonomous preference would reject**. Magic creates no biological capacity: it cannot fund a replacement the Tuber cannot fund, produce an impossible structure, skip the time a biological process takes, or reverse death. And a compelled route costs **exactly** what the same route costs when the plant chooses it — **no magical discount** in expenditure, emergence time, resulting manifestation or subsequent vulnerability.
- **Rationale:** The divergence between plant interest and Warden utility is the intended tension, and undiscounted cost is what keeps it honest. A cheaper forced emergence would turn astral intervention into a free optimizer and quietly void the funding model (AMO-D095, AMO-D096).
- **Consequences:** A player may knowingly take biologically poor decisions — forcing late replacement, spending conserved reserves, keeping an individual active, carrying an animated Amorpho through hostile climates, rooting it where biology would never settle — and consequences arrive only through existing systems: condition, reserves, Developmental Maturity, future manifestation potential and Pathological Tuber Impact where actual persistent loss occurs (AMO-D092). **No abuse meter, morality score, plant happiness state, consent dialogue or emotional AI** is created. Once rooting ends the magical action, **Environmental Fit resumes authority** over the site that was chosen (AMO-D033, AMO-D037, AMO-D054). Recorded as L52 ([26_PLANT_AUTONOMY_ASTRAL_LEVERAGE_AND_ROUTING_V0.md](26_PLANT_AUTONOMY_ASTRAL_LEVERAGE_AND_ROUTING_V0.md)).

## AMO-D101 — Direct astral presence must be established, and there is only one of it
...
## AMO-D114 — Functional Collapse is loss of active-Leaf role viability

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Functional collapse boundary brief, owner-supplied design direction
- **Decision:** A mature Leaf reaches **Functional Collapse** when it can no longer meaningfully serve as the active Leaf manifestation, judged from its **current** biological capability and trajectory. Imperfection, scarring, reduced Structural Integrity, reduced Leaf Functional Capacity, ongoing decline and low biological output are **not** Collapse. The test is baseline-independent: it is never a fall below a hypothetical healthy original, so it applies equally to a Leaf that deployed imperfectly. Tuber-level Replacement and retreat routing begins only after this boundary is reached; physical tissue may remain at that point.
- **Rationale:** Routing had no definition of its own entry condition, and every softer reading would either replace a still-useful Leaf for looking bad or trap the individual with an unserviceable one. Role serviceability is the only test that works for a Leaf that never had a pristine baseline.
- **Consequences:** Collapse is failure of the Leaf role, not of the individual: it is not Tuber death, Pathological Tuber Impact, Developmental Maturity regression, ordinary end-of-phase Senescence or automatic Replacement (AMO-D075, AMO-D092, AMO-D096). It opens routing without selecting a route (AMO-D097, AMO-D098). A fully deployed Replacement Leaf uses the same boundary. The exact criterion, confirmation of Collapse versus transient suppression, and productivity integration remain AMO-Q101, AMO-Q103 and AMO-Q116. Recorded as L56 in [33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md](33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md).

## AMO-D115 — Collapse Commitment is irreversible and ends the Leaf manifestation

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Functional collapse boundary brief, owner-supplied design direction
- **Decision:** When deterioration outruns a mature Leaf's capacity to stabilize so that loss of that Leaf becomes biologically inevitable, the Leaf crosses **Collapse Commitment**, which is irreversible for its active role. A **terminal manifestation period** follows in which the Leaf still physically exists, continues to deteriorate and has no path back to active viability; when the course is gradual this period is visibly legible as progressive discoloration (*terminal yellowing*). A sufficiently catastrophic acute event may reach terminal loss without that warning phase. At **Terminal Leaf Collapse** the Leaf manifestation ends as a live form: no collapsed-Leaf state, shell or inhabitable remnant persists, and the **Tuber** is the remaining living persistent form from which any later route is taken.
- **Rationale:** A single vague continuum of "more collapsed" would let a doomed Leaf be nursed back by good weather, or leave a dead manifestation lingering as an actor. A committed terminal state with a visible warning gives the player legible biology without a timer or an interface rule.
- **Consequences:** Later favorable conditions may change how the terminal period unfolds, its cost and which routes stay open, never the committed loss of that Leaf. Terminal yellowing shares its visual language with programmed seasonal senescence but not its cause, and both remain a presentation direction rather than a botanical claim (AMO-D024). Routing converges on the Tuber and never on the dying Leaf (AMO-D095, AMO-D099). Duration, stages, terminal-Leaf persistence and old/new manifestation overlap remain AMO-Q084 and AMO-Q101. See [33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md](33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md).

## AMO-D116 — Biological recoverability and astral inhabitability are separate dimensions

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Functional collapse boundary brief, owner-supplied design direction
- **Decision:** A biologically doomed manifestation is not automatically uninhabitable. A Leaf in committed terminal decline may remain temporarily inhabitable while it physically exists, if the existing astral access and Astral Readiness gates are met; Collapse Commitment is not itself a magical disconnect. **Terminal Leaf Collapse** does end normal Leaf inhabitation, because no manifestation remains to enter. The biological definition of Collapse is identical whether the Leaf is inhabited or rooted.
- **Rationale:** Readiness and access were already independent of biological health, and a dying manifestation that is still present is a legitimate, interesting body to use. Equating doom with disconnection would collapse two dimensions the architecture deliberately keeps apart.
- **Consequences:** Embodiment supplies no escape: biological progression and recovery both pause while inhabited and resume when the individual is rooted, and Readiness is restored only by rooted life, so an exit-and-re-enter loop cannot stall the loss (AMO-D072, AMO-D084, AMO-D086). **Revised:** 2026-09-23, terminal embodiment trace — “no escape” refers to the **committed fate**, not to timing. Continuous embodiment may defer terminal progression indefinitely, while every non-embodied interval advances it, so exit-and-re-enter still cannot stall the loss (AMO-D117). Substance unchanged. A terminal manifestation's distinctive visual state may later carry situational gameplay consequences; none is designed or promised (AMO-Q109). The exact inhabitability cutoff during the terminal period and the fate of an embodiment in progress when the manifestation ends remain AMO-Q085, AMO-Q112, AMO-Q113 and AMO-Q115. See [33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md](33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md).

## AMO-D117 — Embodiment suspends terminal progression without changing terminal fate

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Terminal embodiment brief, owner-supplied design direction
- **Decision:** While a manifestation whose loss is committed is continuously inhabited, its biological terminal progression is **suspended** with the rest of its biology, so ordinary terminal collapse cannot complete underneath an embodied Warden. A Warden may therefore hold a doomed manifestation indefinitely and postpone its biological end indefinitely; this is permitted by design. Embodiment never undoes state already reached: on astral exit or rooting, the terminal trajectory resumes from exactly the same committed state, and re-entry pauses it again at wherever it has reached. No reset, healed interval or grace state follows from entering or leaving.
- **Rationale:** The accepted pause and open-ended-embodiment rules already produce this result, and Bloom's paused Programmed Draw is the same case decided the same way (AMO-D084, AMO-D085). Treating the consequence as an exploit would mean inventing a timer the architecture has repeatedly refused.
- **Consequences:** **No** maximum embodiment duration, terminal countdown, forced expulsion, magical strain, hidden deterioration or automatic readiness decay may be introduced to end it. The cost is opportunity cost: One Consciousness stays committed (AMO-D028, AMO-D101), and the individual's own Leaf completion, consolidation, Replacement routing, Dormancy and later cycles all wait for biology to resume. The player influences **when** biological progression continues, never **what** happens to that manifestation (AMO-D115). Whether a very long embodiment is bounded in practice depends on the unresolved Astral Readiness depletion model, which must not become an anti-exploit device (AMO-Q112). Recorded as L57 in [34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md](34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md).

## AMO-D118 — Embodiment ends with the manifestation; the consciousness returns to the human

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Terminal embodiment brief
- **Decision:** Manifestation existence is a hard prerequisite for manifestation inhabitation. When an inhabited temporary manifestation ceases to exist, direct embodiment ends and the Warden's consciousness returns to the persistent human body under the existing astral-return model. No dead-manifestation shell remains playable, and no free-floating astral avatar is created. Being embodied immediately beforehand confers no strategic Tuber presence, routing control or priority; direct presence must be established under the ordinary rules and occupies the same single consciousness.
- **Rationale:** The human body never left the world, so it is the only destination the existing model needs. A roaming astral avatar would add a fourth kind of Warden presence the architecture deliberately does not have, and automatic post-expulsion agency would hand the player free leverage at a routing point.
- **Consequences:** The rule is generic to temporary manifestations and applies to a future Bloom terminal model without new argument (AMO-D071, AMO-Q088). After the manifestation ends, the persistent Tuber may remain reachable through the existing Astral Window, which is contact rather than a body (AMO-D089, AMO-D099). Forced-exit behaviour, presentation and any consequence of an involuntary return remain AMO-Q113; immediate post-return strategic presence remains AMO-Q119. Recorded as L57 in [34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md](34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md).

## AMO-D119 — Astral-state damage and biological persistence are not yet mapped

- **Status:** SUPERSEDED by AMO-D120 · **Date:** 2026-09-23 · **Origin:** Terminal embodiment brief, owner-supplied design direction
- **Decision:** How damage, defeat or destruction in the astral/fighting state relates to the underlying biological manifestation is **undecided**, and neither default may be assumed. It is not permitted to treat fighter damage or destruction as equivalent biological Leaf damage or destruction, and it is equally not permitted to treat astral-state damage as automatically vanishing when embodiment ends. A dedicated future specification must decide whether, when and how an inhabited manifestation can carry consequences that survive de-embodiment.
- **Rationale:** Either silent default would settle a load-bearing boundary by assumption: equivalence would reintroduce an ordinary biological cost for playing the game and collapse the harm horizons, while automatic disappearance would make the fighting layer consequence-free without anyone deciding that.
- **Consequences:** The existing boundary stands unchanged — biology is suspended during embodiment, so an ordinary event affecting the inhabited fighter does not silently write biological damage into the paused plant, and any exceptional carry-through needs explicit design (AMO-D084, L49). No trace may assert a biological outcome for an external or combat event occurring during embodiment. The mapping belongs to AMO-Q026 with AMO-Q113 and AMO-Q109.
- **Superseded:** 2026-09-23, combat body damage brief — the mapping is now decided on an ontological basis: the inhabited manifestation **is** the biological body, so an effect that reaches it is biological damage with no conversion step (AMO-D120). Both prohibitions recorded here survive: no proportional combat-state ↔ biological translation (AMO-D121), and no assumption that effects reaching the body vanish on de-embodiment. What is withdrawn is only this entry's claim that the relationship is undecided, together with its reading that a paused biology cannot be injured (AMO-D123). See [34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md](34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md).

## AMO-D120 — The inhabited Amorpho's body is the biological manifestation; damage reaching it is biological

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Combat body damage brief, owner-supplied design direction
- **Decision:** The animated Amorpho uses the **actual** biological Leaf, Replacement Leaf or Bloom as its body. It is not a projection, duplicate, clone or separate combat avatar, and no risk-free combat copy of an individual may exist. Consequently a hostile effect that **reaches that body** is real biological manifestation damage: it changes the manifestation's biological condition immediately, with no later conversion step, probability roll or carry-over event, and it persists after embodiment ends. De-embodiment reveals that continuity rather than creating it.
- **Rationale:** The two-layer concept depends on the fighter being the plant (AMO-D030, L16). If the fighting body were insulated from biology, combat could have no persistent stake; if biological consequence arrived as a later abstract event, the architecture would need a second damage system to explain it. The decisive question is simply whether an effect reached the body.
- **Consequences:** Body-reaching damage enters the **existing** mature pathway with no combat-specific damage model: Structural Integrity and Leaf Functional Capacity change as for any injury, appearance still decides nothing, and accumulated damage may cross the ordinary Functional Collapse boundary and its Tuber-level routing (AMO-D091, AMO-D114, L51). Damage is physically continuous across entry and exit; scars belong to the body. Whether an effect reaches the body, what magnitude follows, hit locations and what destroys a manifestation outright remain AMO-Q026, AMO-Q086 and AMO-Q109. Supersedes AMO-D119. Recorded as L58 in [35_COMBAT_PROTECTION_MANIFESTATION_BODY_DAMAGE_AND_BIOLOGICAL_PERSISTENCE_V0.md](35_COMBAT_PROTECTION_MANIFESTATION_BODY_DAMAGE_AND_BIOLOGICAL_PERSISTENCE_V0.md).

## AMO-D121 — Combat state and biological manifestation condition are distinct but coupled

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Combat body damage brief, owner-supplied design direction
- **Decision:** The combat/astral state the fighting game runs on and the biological condition of the manifestation are **separate domains with no proportional mapping in either direction**. Combat state answers whether this Amorpho can continue this fight; biological state answers what condition this Leaf or Bloom is actually in. Depleted combat capability is not equivalent biological damage, combat-state exhaustion is not a dead plant, and biological state is not a combat meter. They are nonetheless coupled: real body damage may reduce combat capability, and combat-state loss may occur with little or no biological damage.
- **Rationale:** A fighting game needs its own legible capability layer, while biology needs consequences that outlive an encounter. Equating them would either punish every fight biologically or make biology cosmetic.
- **Consequences:** Recovery domains stay apart — future restoration of combat state repairs no scars, structure or function, and biological stabilization implies nothing about how combat resources return (AMO-D086, L48). One event may touch combat state, protection and the body at once without those being one quantity; how anything distributes is future combat design. Combat may **never** use Tuber condition, reserves or vitality as a hidden combat health pool (AMO-D111, L55). Combat-state semantics, defeat and forced de-embodiment remain AMO-Q026, AMO-Q109 and AMO-Q113. See [35_COMBAT_PROTECTION_MANIFESTATION_BODY_DAMAGE_AND_BIOLOGICAL_PERSISTENCE_V0.md](35_COMBAT_PROTECTION_MANIFESTATION_BODY_DAMAGE_AND_BIOLOGICAL_PERSISTENCE_V0.md).

## AMO-D122 — Protection stands between hostile effects and the biological body

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Combat body damage brief, owner-supplied design direction
- **Decision:** Protection is an architectural layer between an incoming hostile effect and the manifestation body. Magical shields, wards and defensive fields, physical armour and worn protection, and skilful blocking, parrying, evasion and positioning may all intercept an effect fully, partly or not at all. Fully intercepted effects may have combat and protection consequences while the body stays intact; a residual effect that reaches the body is biological damage (AMO-D120).
- **Rationale:** Protection is what makes combat biologically risky without being biologically suicidal, and it ties fighting skill directly to stewardship of a living individual: defending an Amorpho protects a plant, not only a win condition.
- **Consequences:** Two product requirements bind future balance in opposite directions — serious fighting must genuinely risk the manifestation, and regular skilled fighting must remain viable. Protection may itself be depleted or damaged; that is extensibility, not a mechanic. No absorption value, capacity, recharge, durability figure, item, slot or hit-determination rule is defined (AMO-Q026, AMO-Q109). Existing equipment rules are unchanged: worn protection helps the animated body and does not become rooted-plant environmental protection on rooting (AMO-Q048, AMO-Q051). See [35_COMBAT_PROTECTION_MANIFESTATION_BODY_DAMAGE_AND_BIOLOGICAL_PERSISTENCE_V0.md](35_COMBAT_PROTECTION_MANIFESTATION_BODY_DAMAGE_AND_BIOLOGICAL_PERSISTENCE_V0.md).

## AMO-D123 — Biological progression pauses during embodiment; the body is not invulnerable

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Combat body damage brief, owner-supplied design direction
- **Decision:** During embodiment, **ordinary biological progression** stays suspended — growth, productive development, maturity gain, reproduction, life-cycle progression, Programmed Tuber Draw and biological recovery (AMO-D084). **Explicit injury is not progression**: an effect reaching the body is a state change that can damage the manifestation, and a sufficient one can destroy it, even while progression is paused. Destruction ends the manifestation and therefore the embodiment (AMO-D118). Because recovery is among the paused processes, damage accumulates across a long embodiment with no rooted stabilization between encounters.
- **Rationale:** Pause and invulnerability are different claims, and only the first was ever decided. This also resolves how a committed terminal manifestation can end while its terminal progression is suspended: the body was destroyed, it did not biologically age to death (AMO-D115, AMO-D117).
- **Consequences:** **Overuse** — repeated exposure of one manifestation to combat risk without sufficient biological recovery — emerges from accumulated damage and deferred recovery, with no Overuse meter, cooldown, stamina bar or artificial timer, and none may be added. A still-viable damaged manifestation may be withdrawn before Collapse and rehabilitated through ordinary rooted biology and Environmental Fit, with no combat-recovery or infirmary system (AMO-D033, AMO-D094, AMO-Q103). Indefinite terminal embodiment remains permitted and untimed (AMO-D117). Biological recovery during continuous embodiment remains unavailable unless a future decision makes an explicit exception. See [35_COMBAT_PROTECTION_MANIFESTATION_BODY_DAMAGE_AND_BIOLOGICAL_PERSISTENCE_V0.md](35_COMBAT_PROTECTION_MANIFESTATION_BODY_DAMAGE_AND_BIOLOGICAL_PERSISTENCE_V0.md).

## AMO-D124 — An encounter resolves the conflict; it does not require destroying a manifestation

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Combat resolution brief, owner-supplied design direction
- **Decision:** An Amorpho fight is a **conflict under escalating risk**, not inherently a contest to destroy the opponent's manifestation. An encounter may end while both manifestations exist, remain biologically viable and remain capable of continuing. There is **no universal knockout requirement**: no rule says an encounter continues until a body can no longer act. A player may win because the opponent yields, withdraws, flees, loses the objective or can no longer justify continuing, and a player may lose while their manifestation stays alive, viable and usable later.
- **Rationale:** The fighter's body is a cultivated living individual (AMO-D120). A resolution model that requires consuming a body to zero would make every ordinary encounter an act of destruction and would tie combat structurally to biological loss.
- **Consequences:** Combat capability describes whether this Amorpho can keep participating effectively, never how close the manifestation is to biological death (AMO-D121). Some form of incapacitation may still exist later where useful, but it is not the foundational rule. Objective-shaped conflict — holding, protecting, reaching, denying, delaying, controlling — becomes natural; no contest format, arena, matchmaking or ranking follows (AMO-Q026, AMO-Q028). Recorded as L59 in [36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md](36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md).

## AMO-D125 — Four resolution families: surrender, escape, conscious withdrawal, objective resolution

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Combat resolution brief, owner-supplied design direction
- **Decision:** Ordinary encounters resolve through conceptually distinct families that must not collapse into one generic “quit fight”: **Surrender/Yield** (accepting defeat and the opponent's immediate conflict outcome), **Escape/Flee** (preserving autonomy and position by actively disengaging), **Conscious Withdrawal** (judging that further biological or strategic cost is not worth the conflict and ending participation), and **Objective Resolution** (the goal is achieved or becomes impossible). Withdrawal requires neither Functional Collapse nor exhausted combat state, and is not a failure state. Escape is an active, contestable outcome rather than a passive defeat command.
- **Rationale:** Surrender concedes, escape leaves, withdrawal disengages by judgement, and objective resolution removes the reason to fight. Merging them would erase the player's ability to trade a conflict outcome against a living body.
- **Consequences:** Future mechanics owe five requirements: surrender must be a **credible preservation strategy**, surrender must **not be free**, surrender **normally ends hostile continuation within the encounter**, escape must be **neither guaranteed nor impossible**, and **meaningful exits must exist before biological destruction**. Their eventual conflict consequences may differ and are not defined; no control, timing window, pursuit rule or reward follows (AMO-Q023, AMO-Q026, AMO-Q028). Ignored surrender, non-player threats and hostile-behaviour rules are separate future work (AMO-Q008). Withdrawal may be context-dependent, with no context taxonomy created. See [36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md](36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md).

## AMO-D126 — The end of an encounter is not the end of embodiment

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Combat resolution brief, owner-supplied design direction
- **Decision:** Combat participation and embodiment state are separate. Surrender, withdrawal, escape or objective resolution end an encounter without by themselves returning the Warden to the human body or rooting the plant: a Warden who yields may remain embodied, a surrendered Amorpho is not thereby immobilised, and a successful escape happens **while** embodied and may be followed by travel, relocation or rooting at the player's choice.
- **Rationale:** Rooting is a decision with real environmental consequences, not a penalty applied for losing (AMO-D032, AMO-D033). Forcing exit at the end of every encounter would make defeat dictate the individual's biological situation.
- **Consequences:** Whether any future combat-state failure forces exit remains AMO-Q113; terminal loss of the manifestation still ends embodiment because no body remains (AMO-D118, L57). Post-encounter movement, pursuit and disengagement rules remain open (AMO-Q026, AMO-Q028). See [36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md](36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md).

## AMO-D127 — Fighting to manifestation destruction is permitted escalation, never the default

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Combat resolution brief, owner-supplied design direction
- **Decision:** A Warden may refuse surrender, withdrawal and escape and keep exposing the manifestation until it is biologically destroyed. That is **escalation beyond ordinary combat**, not the ordinary resolution model, and the architecture neither prevents it nor penalises it morally. Terminology is fixed: this is a **fight to manifestation destruction**, not a “fight to the death”, because destroying a Leaf or Bloom does not kill the persistent individual.
- **Rationale:** Players must be able to take bad risks knowingly, and the system must not protect them from their own decisions or lecture them. Equally, the vocabulary must not imply that losing a body means losing the individual.
- **Consequences:** No morality meter, forced surrender or automatic protective exit may be added. Destruction follows the existing biological path — accumulated body damage, Collapse, terminal loss (AMO-D114, AMO-D115, AMO-D123) — and the Tuber persists unless separately harmed, so the lifecycle may continue through Replacement, consolidation or a later cycle (AMO-D118). A conflict that genuinely threatened the persistent individual would be a separate, far more extreme category and is neither designed nor authorised. Emergent possibilities — reading escalation, refusal mattering socially — are recorded without design (AMO-Q028, AMO-Q109). See [36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md](36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md).

## AMO-D128 — Encounter resolution does not resolve the conflict; conflict identity follows the Warden

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Combat resolution brief, owner-supplied design direction
- **Decision:** Resolving an encounter does not necessarily resolve the larger conflict: the dispute may persist, the objective may stay contested, the opponent remains in the world and further confrontation remains possible. Losing or leaving one encounter does not erase the Warden's agency in that conflict. **Conflict identity belongs partly to the Warden while the combat body belongs to the chosen Amorpho**, so one Warden may face the same opponent through different manifestations over time.
- **Rationale:** A persistent world needs the two scales separated; otherwise one lost fight would settle matters that the world continues to hold open, and rivalry would be attached to a temporary body.
- **Consequences:** Continuation may later run through another Amorpho, relocation, allies, equipment, the Human or another time and place; none is designed. Embodiment remains **sequential** — no in-encounter switching, no simultaneous bodies, and changing Amorpho uses whatever embodiment process exists (AMO-D028, AMO-D101, L22, AMO-Q040). Bodies carry their biological history into later encounters, so there is no rematch reset; only a genuinely new manifestation is fresh (AMO-D074, AMO-D120). Rivalry, social and history systems remain open (AMO-Q028, AMO-Q120). See [36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md](36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md).

## AMO-D129 — The persistent Tuber travels inside the embodied Amorpho as its central core

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Manifestation destruction brief, owner-supplied design direction
- **Decision:** While a Leaf or Bloom is astrally inhabited and acting as the mobile Amorpho body, the **persistent Tuber is physically carried within that body as its central biological core**. It is not left behind at the previous rooting site, and the Amorpho is not a remote projection of a stationary plant. Movement of the embodied Amorpho therefore physically moves the persistent individual, and rooting establishes the Tuber at the new location, where ordinary rooted biology resumes.
- **Rationale:** The architecture already assumed a player could inhabit an Amorpho and establish that individual somewhere chosen (AMO-D054), which only works if the individual travels. Naming the core's physical position also makes destruction, rescue and custody expressible without inventing a transport abstraction.
- **Consequences:** The physical layering is **protection → manifestation body → persistent core**, and it changes no damage rule: ordinary body-reaching damage damages the manifestation, is not automatic Tuber injury, and the Tuber is never a combat health pool (AMO-D120, AMO-D121, L55, L58). Direct Tuber injury remains its own extreme pathway (AMO-D090). **Core exposure** is named only as a physical concept; no hit location, body zone or core-targeting mechanic follows (AMO-Q109, AMO-Q117). Carrying one's own attached Anchor while relocating is not Anchor reallocation (AMO-D062). Describing the core as the Amorpho's "heart" is imagery, not anatomy. Recorded as L60 in [37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md](37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md).

## AMO-D130 — Manifestation destruction exposes the actual Tuber where it fell; nothing respawns

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Manifestation destruction brief, owner-supplied design direction
- **Decision:** Complete physical destruction of a manifestation removes the temporary body and **exposes whatever persistent Tuber actually remains, at the location where the Amorpho fell**. Nothing teleports home, no replacement Tuber appears in an inventory, nothing returns to a previous pot, and no remains are generated as loot or assigned to whoever won the encounter. What is exposed is the same individual with its identity, genetics, lineage, Developmental Maturity, condition, prior harm and seasonal history; nothing is regenerated for the occasion. An exposed Tuber is **not playable** — it cannot move, flee, fight or carry itself — so relocation requires another physical actor.
- **Rationale:** Physical continuity is the whole point of the individual riding inside its own fighter. A drop that respawns or auto-assigns would turn a living individual into an item and erase the geography of the loss.
- **Consequences:** Collapse location becomes strategically meaningful, and the architecture must not assume only the owner can interact with the remains: **pickup establishes physical custody, never ownership, the Warden bond, astral authorisation or lineage** (AMO-D065, L43). The Tuber may be astrally reachable through the existing Astral Window, which is contact rather than a body (AMO-D089, AMO-D099). Rescue actors, carrying, theft, capture and ownership remain AMO-Q046, AMO-Q047, AMO-Q130, AMO-Q008, AMO-Q091 and AMO-Q093. A recovered Tuber stays biologically simulated while unrooted (AMO-D093, AMO-Q117) and is not a respawn token: later Replacement still depends on capacity, opportunity and routing (AMO-D096, AMO-Q101). See [37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md](37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md).

## AMO-D131 — Survival after destruction depends on Tuber Core Viability

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Manifestation destruction brief, owner-supplied design direction
- **Decision:** **Tuber Core Viability** asks whether, if the current manifested body were completely lost now, the remaining Tuber could continue as a living persistent individual. It is a qualitative biological evaluation, not a meter or threshold. If a viable core remains, the manifestation is lost and the individual survives as an immobile Tuber awaiting rescue. **If no viable core remains, the persistent biological individual is lost.** Viability is **history-dependent, never a calendar rule**, and reflects construction expenditure, active-season work already performed, condition and prior harm.
- **Rationale:** The core carried inside the fighter is not constant across a season: it is depleted by building the manifestation and may be rebuilt by that manifestation's later work. Total-loss risk therefore has to be evaluated from actual biological history, or destruction would carry either no consequence or an arbitrary one.
- **Consequences:** Manifestation destruction is **not** automatic death of the individual, and it is **not** ordinary Functional Collapse, which concerns failure of the active Leaf role (AMO-D114). **Viable does not mean healthy** — a survivor may be depleted, damaged or pathologically affected and still need favourable re-rooting. **Destruction ends the manifestation, not the season's history:** biological work already performed remains part of the persistent outcome and the Tuber is never rolled back. If no viable core survives, no living individual remains for an Astral Window to operate on (AMO-D099). The viability criterion belongs to AMO-Q104 with AMO-Q102, and how productive work becomes persistent capacity remains AMO-Q116. See [37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md](37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md).

## AMO-D132 — The Astral Anchor travels with the core and may outlive the individual

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Manifestation destruction brief, owner-supplied design direction
- **Decision:** The **Astral Anchor** is physically associated with the persistent Tuber core rather than fixed to a temporary Leaf surface. It therefore travels with the Tuber into the embodied Amorpho, through movement, and through the loss of a manifestation, and the same Anchor remains with the individual across seasonal manifestations without a new one appearing. If destruction leaves no viable core, the individual is gone and **the physical Anchor may remain at the site as an object**; it is not automatically destroyed with the plant.
- **Rationale:** Anchors were already bound to the persistent individual rather than to a pot or place (AMO-D061), so the core is where they belong. Making that explicit removes any need for per-manifestation re-anchoring and creates the canonical extreme remnant: an Anchor with no living plant.
- **Consequences:** An Anchor is **not** the individual — its survival preserves nothing biological, and an empty Anchor is an object rather than a plant. No rebinding, reuse, inheritance, repair or destruction rule follows, and whether combat can damage an Anchor separately stays open (AMO-Q089, AMO-Q090, AMO-Q091). The human-hands rule is untouched: carrying one's own attached Anchor is not attaching, removing or reallocating it (AMO-D062, L42). See [37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md](37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md).

## AMO-D133 — Embodiment eligibility and deployment risk are separate questions

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Manifestation destruction brief, owner-supplied design direction
- **Decision:** *When can the Warden inhabit?* remains answered by Full Deployment and the ordinary access, inhabitability and Astral Readiness gates (AMO-D063, AMO-D107). *When should the Warden risk this individual?* is a separate strategic judgement informed by Tuber Core Viability. **Core viability governs the consequences of total body loss, not permission to embody**, and no lockout may be added because a core is depleted unless existing biology independently requires it.
- **Rationale:** The interesting situation is precisely that embodiment may be permitted while total-loss risk is extreme, leaving the choice to the player. A permission gate would replace that judgement with a rule.
- **Consequences:** Three considerations stay conceptual rather than statistical: **fighter quality**, **core security** and **capture value**. They can move in opposite directions — a pristine newly deployed body may be the most dangerous thing to risk, while a scarred late-season one may sit on a robust core (L51) — and neither direction is guaranteed, since poor conditions or prior damage can leave a late core weak. Early destruction may leave an opponent nothing living to recover: an **emergent** anti-capture trade-off, so no self-destruct mechanic may be added. No economics, rarity tier, optimum or correct deployment timing is defined (AMO-Q116, AMO-Q093). See [37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md](37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md).

## AMO-D134 — One manifestation body across modes; appearance is not a proxy for core condition

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Manifestation destruction brief addendum, owner-supplied design direction
- **Decision:** Rooting and embodiment do **not** create two Leaf or Bloom bodies. The same manifestation persists across the rooted biological form and the Warden-inhabited mobile form, so its physical history is continuous in both directions: damage the rooted Leaf already carries remains when it is later inhabited, and damage taken while embodied remains when rooted biology resumes. There is no conversion step, no reset and no separate fighter copy. Separately, **visible manifestation condition records the manifestation's history, not the persistent core's**: it does not reveal current core capacity, Tuber Core Viability, accumulated productive return or post-destruction salvageability.
- **Rationale:** One body is the direct consequence of the fighter being the plant (AMO-D030, AMO-D120), and it removes any need for damage to travel between modes. Keeping appearance separate from core condition preserves genuine hidden state: the core's history is made of construction cost, productive work and condition, none of which the exterior records.
- **Consequences:** None of these inferences is permitted — *same visible damage → same remains*, *scarred fighter → valuable core*, *worn fighter → depleted core* — and damage **source** cannot be read off appearance either. Two similar-looking Amorphos may differ completely in what destroying them would expose, which creates natural **information asymmetry**: an observer may perceive visible damage, protection condition where perceptible and obvious terminal states, while core security stays hidden. A pristine body is a genuine **signal, not proof**, since a well-protected later-season manifestation may still look excellent. The early-embodiment case is dangerous precisely because the biological pause suspends rebuilding while combat damage accumulates (AMO-D117, AMO-D123). A severely depleted core is **still** the persistent Tuber — what may be absent is an independently viable survivor of catastrophic destruction, never the individual's core itself (AMO-D058, AMO-D129, AMO-D131). No scanning, inspection, readout or interface mechanic follows (AMO-Q111, AMO-Q109), and L51 extends to this domain. See [37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md](37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md).

## AMO-D135 — Active Leaf Productive Return: biological work that may alter persistent Tuber state

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Productive return brief, owner-supplied design direction
- **Decision:** **Active Leaf Productive Return** is the useful biological contribution a mature, functioning Leaf produces during **rooted active life**, which may improve or support the persistent individual. It is not experience, score, currency, a default visible meter or elapsed time. **Leaf Functional Capacity is an input and bound, not the return itself**: capacity describes what the manifestation can do, return describes what persistent result actually arises over biological time, and the relationship is deliberately **not linear**. Return depends jointly on capacity, Environmental Fit, current biological condition, actual rooted biological time and Remaining Productive Opportunity, with no weighting between them. **Time enables return and never guarantees it.**
- **Rationale:** Every biological trace from mature damage through combat ended at "what did the season actually produce?", and the answer had to be biological work rather than a meter, or consequence would follow appearance and elapsed time instead of function and conditions (AMO-D091, L51).
- **Consequences:** It names the Leaf-side middle of the existing chain `Fit → opportunity → condition/reserves/growth → development` and adds no new chain (AMO-D081). **Active Leaf Work** and **Persistent Tuber Benefit** stay distinct, forbidding *Leaf worked → equivalent Tuber gain*; no conversion efficiency or stored field is defined. Possible destinations — replenishment, condition, Core Viability, developmental progress through the existing chain only, future manifestation potential — are **destinations, not an allocation scheme**. **No single Tuber balance and no energy currency** may be introduced, and Bloom's Programmed Tuber Draw remains separate normal expenditure (AMO-D087). Nothing maps to combat statistics (L5, AMO-Q109), and nothing reaches the Evolutionator (AMO-D012). Everything quantitative remains AMO-Q116. Recorded in [39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md](39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md).

## AMO-D136 — Embodiment suspends ordinary Productive Return

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Productive return brief, owner-supplied design direction
- **Decision:** Because ordinary biological progression is suspended during embodiment, **ordinary Productive Return does not accumulate while the individual is inhabited** (AMO-D084, AMO-D123). Time spent embodied is time in which remaining opportunity is not being converted into rooted productive return, even though the Leaf exists, the core rides inside it, combat may occur and explicit injury may still damage the body.
- **Rationale:** Return is biological work, so it can only arise where biology is running. This also supplies the accounting explanation for a case already accepted: an early-inhabited, long-embodied Amorpho can become battle-worn while its core stays near its post-construction state (AMO-D134).
- **Consequences:** Early-season vulnerability follows from accounting rather than from any rule, so **no post-emergence danger timer may be added**, and Tuber Core Viability can improve only through rooted productive life (AMO-D131). What pauses is the **individual's own** progression, including phase progression (AMO-D117); the World continues regardless (AMO-D009, AMO-D085). See [39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md](39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md).
- **Revised:** 2026-09-23, world time brief — the interaction this entry left open is now **closed**: World time continues during embodiment, and changing external conditions can consume currently available seasonal opportunity even while the individual's biological progression stays paused. Missed opportunity is not banked (AMO-D145). Substance unchanged; the open clause is withdrawn. See [42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md](42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md).

## AMO-D137 — Realized Productive Return survives later manifestation loss

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Productive return brief, owner-supplied design direction
- **Decision:** Productive Return already realized is **never retroactively erased** by later damage to, Collapse of, or destruction of the manifestation that produced it. What losing a manifestation forfeits is its **future** work: after Functional Collapse further return from that Leaf becomes unavailable or biologically negligible, and destruction ends it outright.
- **Rationale:** *A lost Leaf forfeits its future work, not the work already done.* Without this, every loss would retroactively undo a season and the persistent individual would stop being persistent.
- **Consequences:** Timing dominates outcome: early loss means little banked history and much forgone opportunity, late loss may mean substantial history already secured and little opportunity left — so **the same final loss produces radically different persistent outcomes**, which is why Core Viability follows accumulated history rather than the event (AMO-D131, AMO-D134). Mature damage reaches persistent outcome **through function and opportunity**, never as a direct debit (AMO-D079, AMO-D111, L55). Withdrawal and rooting can preserve future opportunity; fighting to destruction sacrifices it while keeping what was produced (AMO-D124–AMO-D127). Recorded as L61 in [39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md](39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md).

## AMO-D138 — Insufficient return is not pathology; return and pathology are orthogonal

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Productive return brief, owner-supplied design direction
- **Decision:** **Failure to obtain possible future benefit is not automatically Pathological Tuber Impact.** A phase may end with little gain, no net gain, or depletion relative to investment without harmful persistent loss. Productive Return and Pathological Tuber Impact are **orthogonal**: an individual may receive real return *and* suffer a direct injury, or suffer no injury *and* receive insufficient return, and they may never be collapsed into one "Tuber health" score. Direct harm to the Tuber **bypasses productive accounting entirely** and needs no explanation as negative productivity.
- **Rationale:** The harm model already separates a disappointing season from a damaging one (AMO-D082, AMO-D092). Naming productive return would have quietly reintroduced the collapse it forbids unless the orthogonality were stated with it.
- **Consequences:** **Replenishment and net gain stay distinct**, so real work may show no net gain while the individual genuinely improves, and no baseline is defined for "the prior state". Two accounting entries stay distinct as well: **capacity spent or lost** versus **productive opportunity lost**, and lost opportunity is never regression (AMO-D082). Doc 21's existing outcome range — gaining, approximately maintaining, or losing to harmful circumstances — is unchanged, with **insufficient return** describing the third case short of harm; these are qualitative descriptions, not enum values or thresholds. **When ordinary depletion, missed gain or insufficient return becomes actual persistent harmful loss remains AMO-Q118.** See [39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md](39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md).

## AMO-D139 — Mature recovery reorganizes surviving architecture; it never reconstructs what was lost

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Recovery ceiling brief, owner-supplied domain direction
- **Decision:** Rehabilitation of a damaged mature Leaf consists of **Structural Stabilization** (surviving damaged architecture becoming mechanically and biologically stable enough to persist rather than continuing to fail), **Scarring** (permanent visible consequences that remain part of the manifestation), and **Compensatory Remodeling** (biological reorganization of surviving structures so the remaining architecture carries more useful function than it could immediately after the damage). None of these reconstructs lost mature architecture, restores original geometry or rewinds the Leaf to its pre-damage form. Recovery **changes how effectively surviving architecture works without restoring the architecture that was lost** (AMO-D094).
- **Rationale:** The owner's direction is that a mature Leaf reorganizes rather than rebuilds. Naming the three processes separately prevents "recovery" from silently meaning regrowth, and prevents stabilization from being mistaken for regained function.
- **Consequences:** Rehabilitation runs only while rooted biological life does — it is among the processes embodiment suspends — and **rooting re-enables it rather than performing it** (AMO-D084, AMO-D123). Stabilization has value before any function returns, because it protects what remains recoverable (AMO-D141). Compensation is bounded: it never makes a damaged Leaf exceed what its undamaged architecture could do, and damage confers no advantage. Magic changes nothing — embodiment does not heal, exit and re-entry repair nothing, and magical healing does not rebuild mature structure (AMO-D072, AMO-D086, L48–L50). Damage origin is irrelevant: environmental, pest, mechanical, developmental and combat injuries all use this one architecture, with **no combat-specific healing subsystem** and no healing currency. Bloom is out of scope (AMO-Q088). Mechanisms, representation and any biological demand rehabilitation makes remain AMO-Q103; no real physiology is claimed (AMO-D024). Recorded as L62 in [40_ROOTED_MATURE_LEAF_RECOVERY_CEILING_AND_COMPENSATORY_REMODELING_V0.md](40_ROOTED_MATURE_LEAF_RECOVERY_CEILING_AND_COMPENSATORY_REMODELING_V0.md).

## AMO-D140 — Functional Recovery may be substantial despite permanent structural loss

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Recovery ceiling brief, owner-supplied domain direction
- **Decision:** After serious damage a Leaf's Functional Capacity may fall sharply and then recover **substantially** once rehabilitation runs, while its structure remains permanently altered and visibly scarred. **Severe visible damage does not imply permanently equally severe functional loss**, and a recovery that never reaches the Leaf's former attainable state can still be a successful recovery. Success is judged functionally — stable structure, viable surviving architecture, useful capacity restored, the active phase able to continue — never by looking new again.
- **Rationale:** Without this, every serious injury would effectively end a manifestation's usefulness, and the difference between a wound and a ruin would disappear.
- **Consequences:** Appearance, current Functional Capacity and Recovery Ceiling stay three distinct things, extending L51: a Leaf may be heavily scarred, mechanically stable and functionally strong at once. **Fresh injury and old compensated injury may look alike and behave differently** — the same visible missing architecture can support very different current function — and the domain model should be able to express that distinction without any new state, field or player inspection mechanic being created here (AMO-D134, AMO-Q111). Scars are history, never bonuses, and confer no combat advantage (AMO-Q109). Whether a Leaf worth rehabilitating is also worth risking again is a player judgement, not a rule. See [40_ROOTED_MATURE_LEAF_RECOVERY_CEILING_AND_COMPENSATORY_REMODELING_V0.md](40_ROOTED_MATURE_LEAF_RECOVERY_CEILING_AND_COMPENSATORY_REMODELING_V0.md).

## AMO-D141 — Recovery Ceiling: what this manifestation could still regain, and damage lowers it

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Recovery ceiling brief, owner-supplied domain direction
- **Decision:** A damaged mature Leaf has a qualitative **Recovery Ceiling**: the highest Functional Capacity it could still plausibly regain from its surviving architecture and condition during this phase. It is distinct from current Functional Capacity — a freshly damaged Leaf may have low current capacity and a much higher ceiling, and rehabilitation moves the first toward the second. **Damage can permanently lower the ceiling**, because lost architecture is not rebuilt, and the reduction is **not proportional to visible damage**: compensation may let surviving structure support disproportionately useful function, while a small strategically placed loss may cost a great deal. Favourable conditions help a Leaf realize what remains recoverable and **cannot recreate architecture that no longer exists**.
- **Rationale:** Recovery needed an upper bound that comes from surviving biology rather than from a number, and the current-versus-recoverable distinction is what makes withdrawing a still-capable fighter a rational biological act instead of sentiment.
- **Consequences:** Further body-reaching damage may lower current capacity, destabilize structure, destroy surviving architecture **and lower the remaining ceiling**, so continuing a fight can permanently reduce what that Leaf will ever recover to — and staying embodied through repeated encounters suspends rehabilitation while that accumulates (AMO-D123, AMO-D136, AMO-D125). **v0 direction:** rehabilitation moves current function toward what surviving biology can still support and does not restore ceiling already lost merely through time; whether anything can raise a reduced ceiling within a phase is left open (AMO-Q103). A ceiling belongs to its manifestation only and ends with it; a later manifestation is newly constructed and inherits no missing structure, while persistent Tuber consequences carry forward separately (AMO-D074, AMO-D113). **Recovery potential and Remaining Productive Opportunity are independent axes**, with all four combinations legitimate and no decision matrix defined (AMO-D135, AMO-Q101, AMO-Q116). Before Collapse Commitment recovery may avert Collapse; after it, the ceiling for continued active-Leaf viability stops mattering and no terminal recovery exists (AMO-D114, AMO-D115, AMO-D117). No ceiling value, threshold, damage mapping or readout is defined, and the Warden may have no precise knowledge of it (AMO-D134). See [40_ROOTED_MATURE_LEAF_RECOVERY_CEILING_AND_COMPENSATORY_REMODELING_V0.md](40_ROOTED_MATURE_LEAF_RECOVERY_CEILING_AND_COMPENSATORY_REMODELING_V0.md).

## AMO-D142 — Bloom existence is evidence of substantial prior persistent capability

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Bloom core security brief, owner-supplied domain direction
- **Decision:** A Bloom exists only because the persistent Tuber had enough biological capability to fund that manifestation. A fully developed Bloom is therefore **evidence that the individual possessed substantial biological capacity when the Bloom was produced** — a lower-bound signal, not a core readout. This sharpens rather than contradicts AMO-D134: **surface wear does not reveal core state, but manifestation *type* may itself carry biological information.** A Bloom's own appearance still resolves nothing, and *bigger or prettier Bloom → bigger Tuber* is rejected; the signal lies in existence, not cosmetics.
- **Rationale:** The asymmetry is already implied by the existing flowering-maturity gate (AMO-D078) and by the Tuber funding every manifestation (AMO-D095). Naming its informational consequence gives Bloom a strategic identity that does not depend on inventing capabilities, and it does so without letting anyone read a hidden quantity off a surface.
- **Consequences:** Seeing a Bloom is a genuine **information event** in the world — something real is learned, with no figures and no interface announcing it; the player already distinguishes Bloom from Leaf, so no icon, indicator or scan is added (AMO-Q111). A Leaf remains weak evidence: it may conceal a robust, weak or non-salvageable core, and freshness is a clue rather than proof (AMO-D134, AMO-D136). No Developmental Maturity value is exposed through Bloom (AMO-D080, L47), no numerical or real-world flowering threshold is introduced (AMO-D024), and no species ranking follows (AMO-Q110). Existing eligibility requirements stay meaningful and undefined here (AMO-Q107). Recorded as L63 in [41_BLOOM_EMBODIMENT_CORE_SECURITY_AND_DESTRUCTION_VALUE_V0.md](41_BLOOM_EMBODIMENT_CORE_SECURITY_AND_DESTRUCTION_VALUE_V0.md).

## AMO-D143 — Bloom embodiment carries the same physical core; destruction exposes the actual Tuber

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Bloom core security brief
- **Decision:** Bloom embodiment changes nothing about the physical ontology: the persistent **Tuber travels inside the inhabited Bloom as its central core**, the **Astral Anchor** travels with it with no special Bloom binding, embodied movement moves the individual, and there is no separate Bloom projection or copy. Damage reaching the Bloom body is **real biological Bloom damage** through the ordinary protection → body → core layering, and is not automatic Tuber injury. If the Bloom body is destroyed, embodiment ends and **the actual current core is exposed at that location** under the existing architecture.
- **Rationale:** One manifestation ontology must serve both active forms, or Bloom would quietly acquire separate physics (AMO-D120, AMO-D129, AMO-D130).
- **Consequences:** **No Bloom loot rule exists:** nothing is generated, nothing teleports, and nothing is awarded automatically to a winner — what remains is the actual Tuber that was inside, valued as biological continuity rather than a drop. Recovering it is **physical custody**, never ownership, bond or astral authorisation (AMO-D065, L43). Bloom-specific mature damage and recovery are **not** designed: doc 40's recovery architecture is Leaf-scoped and Bloom's response remains AMO-Q086 with AMO-Q088. Direct Tuber harm remains its own extreme pathway that no information rule overrides (AMO-D090). See [41_BLOOM_EMBODIMENT_CORE_SECURITY_AND_DESTRUCTION_VALUE_V0.md](41_BLOOM_EMBODIMENT_CORE_SECURITY_AND_DESTRUCTION_VALUE_V0.md).

## AMO-D144 — Bloom raises core-security confidence without guaranteeing current viability

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Bloom core security brief, owner-supplied domain direction
- **Decision:** **Bloom capability evidence** (this individual successfully funded a Bloom — a permanent historical fact) and **current core salvageability** (whether the exposed Tuber could continue as a viable individual if the body were lost now) are distinct: the first informs the second and never determines it. Bloom production and maintenance cost **Programmed Tuber Draw**, so **Bloom existence proves prior capability, not unlimited current reserves**, and destruction exposes the *current* core rather than the pre-Bloom one. A normal Bloom Amorpho should **usually** imply a substantial, rescue-relevant core; this is deliberately not an unconditional law, because severe direct injury, extraordinary depletion or pathology may leave less. What is canonical is that **Bloom substantially raises confidence that meaningful core value exists without guaranteeing it.**
- **Rationale:** A guaranteed-value signal would turn a Bloom into a visible loot marker and erase the information asymmetry the architecture depends on; no signal at all would waste a fact the biology genuinely establishes.
- **Consequences:** Two Blooms may conceal very different internal states, and Bloom destruction refunds none of what producing it cost (AMO-D087, AMO-D137). Ordinary resolution remains fully available — surrender, escape, conscious withdrawal and objective resolution all apply, with **no stronger Bloom surrender penalty** and no forced surrender (AMO-D124–AMO-D127). The incentive asymmetry is preserved without being designed: a Warden embodying a Bloom knowingly carries a signalled core into risk, and an opponent may reasonably expect destruction to expose more than an apparently fresh Leaf would — with no reward, drop probability, aggression rule, AI utility or capture economics defined. Bloom is thereby strategically distinct **before** any Bloom move exists (AMO-Q088, AMO-Q109). Bloom performs no Active Leaf Productive Return, and future reproductive return is its own architecture (AMO-D135, AMO-Q079). See [41_BLOOM_EMBODIMENT_CORE_SECURITY_AND_DESTRUCTION_VALUE_V0.md](41_BLOOM_EMBODIMENT_CORE_SECURITY_AND_DESTRUCTION_VALUE_V0.md).

## AMO-D145 — Seasonal opportunity may pass while biology is paused; missed opportunity is not banked

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** World time brief, owner-supplied design direction
- **Decision:** **World Time and Individual Biological Progression are two clocks.** Embodiment freezes ordinary biological progression of the inhabited individual; it never freezes the World, which continues to produce day and night, weather, seasonal change and changing local suitability (AMO-D009, AMO-D046, AMO-D136). **Remaining Productive Opportunity is therefore not frozen because biology is frozen**: suitable rooted conditions may pass unused while the Warden remains embodied, and that opportunity may simply be lost. Missed opportunity is **not banked** for later and is never repaid.
- **Rationale:** A paused individual inside a moving world is the natural limiter the architecture already wanted: it makes long embodiment genuinely expensive without any timer, and it closes the ambiguity AMO-D136 had deliberately left open.
- **Consequences:** Three shortcuts are forbidden — elapsed World time is **not** Productive Return, **not** biological maturity, and **does not** strengthen the persistent core (AMO-D081, AMO-D131, AMO-D135, L47). **Lost opportunity is a cost, not damage**: a missed season involves no pathology, direct injury or automatic deterioration, which matters directly to AMO-Q118 (AMO-D092, AMO-D138). Embodiment stays open-ended with **no forced exit, maximum duration, decay timer or cooldown** (AMO-D117, AMO-D085). Rehabilitation likewise waits for rooting while opportunity may shrink, so Recovery Ceiling and Remaining Productive Opportunity remain independent axes (AMO-D139, AMO-D141). Missed opportunity is historically real and still not readable from the body (AMO-D134). AMO-Q004 and AMO-Q074 keep time scale and granularity; AMO-Q116 keeps the quantitative model. Recorded as L64 in [42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md](42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md).

## AMO-D146 — Environmental suitability and intrinsic lifecycle permission are separate

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** World time brief addendum, owner-supplied design direction
- **Decision:** **Suitable World conditions do not automatically mean an individual is biologically prepared to continue active growth.** Useful rooted active growth requires both **External Productive Opportunity** (does this place and time provide suitable conditions? — World, via Environmental Fit) and **Biological Growth Availability** (can this individual currently use them? — the Amorpho's lifecycle state). **Intrinsic Lifecycle Drive** is the working name for the individual's own tendency or requirement to continue active growth, move toward dormancy, remain dormant or resume growth; it is qualitative, adds no state and needs no field. **Relocation changes environmental opportunity and cannot by itself reset the intrinsic lifecycle**: a Warden can chase suitable weather, but cannot necessarily outrun dormancy, and once biology has committed to a dormancy transition, travel alone does not cancel it.
- **Rationale:** Once seasonal opportunity is real and the Amorpho is mobile, a player could otherwise bypass an individual's lifecycle by continuously travelling. The answer is the existing ownership boundary rather than a rule against travel: Fit may push toward activity or retreat but never becomes the life-cycle system, and no `force_bloom` or `prevent_dormancy` flag exists (AMO-D035–AMO-D037, AMO-D046).
- **Consequences:** Nothing resets at a border, latitude or hemisphere — the individual carries its Tuber state, productive history, damage, lifecycle state and prior opportunity use across any distance. No hemisphere shortcut in either direction, and no `winter → productivity disabled` rule: **season follows place, not game permission** (AMO-D045, L9). Travel itself accrues nothing; benefit requires rooting, resumed biology and genuinely suitable conditions (AMO-D136). **Continuous growth remains genuinely possible** where an individual's biology permits it — no artificial mandatory dormancy is imposed for fairness. Controlled environments modify local World conditions and never override biology: greenhouse suitability plus a dormancy-requiring individual is not forced growth, and low unmodified factors stay limiting (AMO-D014, AMO-Q049). Environment may still **influence** the lifecycle without being sovereign over it. Triggers, timing and any commitment boundary remain AMO-Q101 and AMO-Q084; Remaining Productive Opportunity must eventually reflect both constraints without collapsing into a season timer (AMO-Q116). Recorded as L65 in [42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md](42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md).

## AMO-D147 — Species shapes lifecycle strategy; the individual owns current lifecycle state

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** World time brief addendum, owner-supplied design direction
- **Decision:** **Species biology constrains and shapes the lifecycle strategy available to an individual, while the current lifecycle state belongs to the individual Amorpho.** Species-level biology may influence whether prolonged active growth is possible, whether substantial dormancy is normally required, how growth is distributed through active periods, lifecycle sensitivity to extended unsuitable conditions and how readily activity resumes; the individual nonetheless carries its actual active or dormant state, prior active history, condition, Tuber state, environmental history and manifestation history. **Lifecycle is never a species-only lookup.** The architecture must support strategies in which **growth tempo, active-period length and dormancy requirement trade off differently** — and **fairness does not require equal active uptime**.
- **Rationale:** Making every individual equally available all year would erase biological identity, and standardising an annual dormancy to close the seasonal-travel loophole would do the same. Different strategies can be competitive through different strengths instead.
- **Consequences:** Burst-seasonal and extended-growth strategies are recorded as **design space only**; no real species is assigned to any of them, no crude equivalence (*seasonal = fast*, *tropical = always grows*) is permitted, and the trade-off is not universally inverse (AMO-D024, AMO-D053, AMO-Q076, AMO-Q110). **Dormancy is not merely lost gameplay time** and may carry real strengths, while extended-growth biology may be poorly suited to long forced dormancy — consequences remain future modelling, and **no compensating penalty may be invented**. Relocation's and a greenhouse's value are therefore **lifecycle-dependent**, so no universal travel bonus or greenhouse effect exists. **No species permission rules**: strategy combines with actual local Fit, so a species may thrive far from its native region (AMO-D013, L9). Repeated relocation is acclimation and expression, never inheritance; generational change stays with the Evolutionator (AMO-D012, AMO-Q052). Species lifecycle facts remain external and arrive only as approved input if genuinely needed, with **no data column added** (AMO-D024, AMO-D025). See [42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md](42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md).

## AMO-D148 — Ordinary depletion, legitimate expenditure and missed gain are not pathology

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Persistent harm boundary brief, owner-supplied domain direction
- **Decision:** **Ordinary depletion** is a reduction in currently available persistent biological capacity caused by legitimate expenditure, insufficient replenishment or missed productive return, while the persistent structures, capabilities and condition themselves remain fundamentally recoverable through ordinary future biology. It is **not** Pathological Tuber Impact. This covers manifestation and Replacement construction, Bloom's Programmed Tuber Draw, insufficient Active Leaf Productive Return, missed Productive Opportunity, a weakly replenished season and stress. **Severity is not classification**: a Tuber may be dangerously depleted and remain entirely intact, and pathology may never be inferred from how low capacity looks — **cause and history decide, not level**.
- **Rationale:** Paying a legitimate biological cost is not an injury, and what never happened cannot be one. Without this, every expensive Bloom, every replacement and every badly timed season would read as damage, and the harm model's distinction between a disappointment and a disaster would collapse.
- **Consequences:** **Vulnerability is not injury** — heavy spending may leave poor buffering and low Core Viability, changing susceptibility rather than classification (AMO-D092). **Death does not retroactively pathologize expenditure**: an individual lost because a destroyed manifestation left too little viable core was lost to the combination of state and event, not to the earlier spending (AMO-D131). Missed opportunity may **contribute causally** to a later harmful outcome without itself being pathology (AMO-D145). Poor Environmental Fit is never pathology by itself (AMO-D035–AMO-D037). The model must conceptually distinguish expenditure, missed gain, depletion, direct injury and persistent degradation, with **no schema, log or record format defined** (AMO-Q120). Recorded as L66 in [43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md](43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md).

## AMO-D149 — Persistent harm requires actual degradation of persistence, and survives turnover

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Persistent harm boundary brief, owner-supplied domain direction
- **Decision:** **Persistent harmful loss** exists when the Tuber has lost or degraded persistent biological structure, capability or condition in a way that is not merely the absence of replenishment and cannot be described as ordinary recoverable depletion alone. Crossing that boundary **changes the ontology**: before it the individual is *depleted*, after it the individual has been *harmed* — a different biological fact, not a worse value on one meter. Cumulative adverse history **may** cross it, but only when persistent capability has actually degraded; **no single episode and no event count crosses anything by itself**. Pathology is **persistent, not permanent**: it belongs to the individual and survives manifestation turnover, without being irreversible, untreatable or lethal.
- **Rationale:** The indirect pathway needed one step more than "a bad season", or every poor outcome would become injury; and the persistent layer exists precisely so that real harm is not erased by growing a new body.
- **Consequences:** Neither a new manifestation, a Replacement, dormancy nor elapsed time erases persistent harm — only a genuine persistent-recovery process could, and **none is designed** (AMO-D074, AMO-D096, AMO-D145, AMO-Q102, AMO-Q105). Pathology does **not** automatically regress Developmental Maturity, though a harmed or depleted individual may be unable to **express** the maturity it has (AMO-D082, AMO-Q106). Pathology and Productive Return coexist in both directions with no netting (AMO-D138). Persistent harm may exist **before any visible symptom**, and no diagnostic is defined. Persistent pathology is accepted as a **future lower-priority layer** — possible causes, symptoms, susceptibility, diagnosis and treatment are deliberately not canonised here (AMO-Q105). See [43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md](43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md).

## AMO-D150 — Replenishment of capacity and repair of persistent harm are separate processes

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Persistent harm boundary brief, owner-supplied domain direction
- **Decision:** **Replenishment** restores available biological capacity through ordinary successful biology; **persistent recovery or repair** addresses actual persistent harm. They are distinct processes and may not be merged into one notion of health. An individual may require **both at once**. Ordinary depletion has a complete non-pathological path back — depleted Tuber, later successful rooted Leaf, Productive Return, capacity rebuilt — with no healing event required; persistent harm needs more than replenishment, and later productive success does not make the harm not have happened.
- **Rationale:** Collapsing the two would make any good season quietly cure real damage, and would leave no way to express a plant that is both empty and injured.
- **Consequences:** No **single Tuber health value**, pathology score, damage meter or reserve percentage may represent persistent condition: available capacity, Core Viability, Developmental Maturity and pathological harm stay qualitatively different facts (AMO-D056). Repair, treatment, rates, reversibility and any scar-like persistent outcome remain open, with AMO-Q102 owning recovery dynamics and **AMO-Q105 the single broad owner of any future repair, care or pathology-management layer** — no per-cause, per-disease, per-symptom or per-treatment question may be created. See [43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md](43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md).

## AMO-D151 — Core Viability and pathology are separate derived dimensions

- **Status:** ACCEPTED · **Date:** 2026-09-23 · **Origin:** Persistent harm boundary brief, owner-supplied domain direction
- **Decision:** **Tuber Core Viability and Pathological Tuber Impact are different questions.** A Tuber may be **non-viable without ever having been harmed**, simply too depleted to continue independently, and **pathological while still viable**, because persistent damage occurred yet enough function remains. Core Viability is derived from the individual's total actual state and does **not** reveal which pathway produced the vulnerability.
- **Rationale:** Making a non-viable core imply pathology would retroactively classify legitimate expenditure as injury, and would break the early-destruction model in which a heavily invested individual can be lost with nothing having been damaged (AMO-D131, AMO-D148).
- **Consequences:** Core Viability may worsen through depletion, through pathology or through both, and the verdict says only whether the individual could continue. A Leaf's **Recovery Ceiling** remains manifestation-owned and ends with that Leaf, while pathology is Tuber-owned and continues (AMO-D141). Bloom's core-security signal is unaffected: prior capability evidence is historical, current salvageability may reflect depletion and pathology separately, and Programmed Draw remains non-pathological (AMO-D144, L63). The criterion itself stays AMO-Q104. See [43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md](43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md).
