...
- **Origin** says where a decision came from: *Founding brief*, *Foundation closure brief*, *Embodiment and systems brief*, *World foundation brief*, *Environment v0 brief*, *Strategic rooting brief*, *Interaction boundary brief*, *Condition v0 brief*, *Life cycle and anchors brief*, *Warden progression brief*, *State machine brief*, *Harm and maturity brief*, *Manifestation boundary brief*, *Maturity v0 brief* or *Biology-magic boundary brief* (set by the project owner), or *…, derived* (a conservative consequence worked out in that session).
