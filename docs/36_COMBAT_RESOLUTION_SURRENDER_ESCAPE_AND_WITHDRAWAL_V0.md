...
Terminology matters here. Destroying a Leaf or Bloom is **usually not** killing the individual: the Tuber persists, and the lifecycle may continue through Replacement, consolidation, dormancy or a later cycle (AMO-D115, AMO-D118, [33](33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md), [34](34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md)). What destruction actually leaves is traced in [37](37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md): the persistent core the manifestation carried is exposed where the Amorpho fell, nothing is awarded to the winner, and the individual survives only if that core is still viable (AMO-D130, AMO-D131, L60). This document therefore uses **fight to manifestation destruction** rather than “fight to the death”. A conflict that genuinely threatened the persistent individual would be a far more extreme category, and none is designed or authorised here.
...
**E — escalation to manifestation destruction.** The Warden refuses surrender, withdrawal and escape. Effects keep reaching the body until the manifestation is lost, and embodiment ends with it ([33](33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md), [34](34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md), AMO-D118, AMO-D123). The persistent core it carried is exposed at the site, and whether the individual survives depends on that core's viability ([37](37_MANIFESTATION_DESTRUCTION_TUBER_CORE_VIABILITY_AND_PHYSICAL_DROP_V0.md)). This was an accepted risk, not a punishment.
