...
*Refined 2026-09-23 ([36](36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md)):* also owns the hostile-behaviour side of surrender: what happens when an actor ignores a yield, and how that is constrained between players. The design expectation is that ordinary Warden-versus-Warden combat has a surrender that means something within the encounter (AMO-D125); non-player threats and scripted hostility that do not recognise surrender are separate future work (AMO-Q028).
...
*Refined 2026-09-23 ([36](36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md)):* one part is settled: awakening does not end because an encounter ends (AMO-D126). Rooting remains the ordinary end of embodiment and stays a decision rather than a consequence of defeat. What awakening costs, how long it lasts and what else makes a plant suitable remain open here.
...
*Refined 2026-09-23 ([35](35_COMBAT_PROTECTION_MANIFESTATION_BODY_DAMAGE_AND_BIOLOGICAL_PERSISTENCE_V0.md)):* cultivation's influence on combat now has a concrete channel: cultivation determines which manifestation exists and the condition it is in, and body damage taken in combat persists into that condition (AMO-D120). This question still owns whether and how individual differences reach combat capability, and may not turn Tuber condition into a hidden combat resource (AMO-D121, L55).

### AMO-Q026 — Death, loss and recovery
**Status:** OPEN · **Biological-consequence ontology resolved 2026-09-23 → AMO-D120–AMO-D123** · **Constraints:** AMO-D007, AMO-D011, AMO-D030, AMO-D084
...
*Refined 2026-09-23 ([34](34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md)):* this question owns the deferred **astral-state damage → biological persistence** mapping, and both silent defaults are now forbidden: fighter damage or destruction may not be treated as equivalent biological manifestation damage, and astral-state damage may not be assumed to vanish when embodiment ends (AMO-D119). A dedicated pass must distinguish damage to the animated fighter, damage to the biological manifestation, what survives de-embodiment and any Tuber consequence.
*Refined 2026-09-23 ([35](35_COMBAT_PROTECTION_MANIFESTATION_BODY_DAMAGE_AND_BIOLOGICAL_PERSISTENCE_V0.md)):* the **ontology is now settled** (AMO-D120–AMO-D123): the fighter's body is the biological manifestation, protection decides what reaches it, an effect that reaches it is real biological damage that persists, and combat state maps proportionally onto nothing biological. What this question still owns is the **combat side**: combat-state semantics, what determines that an effect reaches the body, what magnitude follows, what can destroy a manifestation outright, defeat and forced de-embodiment, combat-state recovery, and whether safe or training contexts exist. It may no longer answer by making combat biologically free or by equating a combat meter with biological condition.
*Refined 2026-09-23 ([36](36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md)):* the **resolution model** is now settled (AMO-D124–AMO-D128): encounters end through surrender, escape, conscious withdrawal or objective resolution, with no universal knockout requirement, and ending a fight neither destroys a manifestation nor ends embodiment. What this question still owns on the resolution side is **how** — how an encounter is represented, what each family actually requires of the player, whether any incapacitation concept exists, combat-state semantics, and what determines that an effect reaches or destroys a body. It may not answer by making a knockout the mandatory ending.
*Refined 2026-09-23 ([38](38_END_TO_END_COMBAT_ENCOUNTER_AND_BIOLOGICAL_CONTINUITY_TRACE_V0.md)):* the integration trace confirms the composition and sharpens one point: combat produces no permanent **injury** — everything short of death recovers while the individual lives (AMO-D075) — and the single terminal outcome it can reach is **death**, only via manifestation destruction leaving a non-viable core (AMO-D131), whose criterion is AMO-Q104's. The earlier note here therefore stands as written: this question may not introduce an injury that outlives the individual's recovery, and it may not make defeat a body failure.
...
*Refined 2026-09-23 ([36](36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md)):* also owns the contested side of resolution: pursuit and interception when one side tries to escape, whether an opponent can refuse or ignore a surrender, and what conflict consequences each resolution family carries in a given context. Fixed already: escape is an active contestable outcome, surrender must mean something within the encounter, and a resolved encounter need not resolve the conflict (AMO-D125, AMO-D128).

### AMO-Q130 — Human Warden physical conflict, condition and protection
**Status:** OPEN · **Constraints:** AMO-D028, AMO-D029, AMO-D124
Can the Human Warden physically encounter Amorphos or other hostile actors, and participate directly in a conflict? Does the Human carry a condition or health model of their own, what protection is available, and what are the consequences of harm to a Human who is not in trance?
*Notes:* Raised by the combat-resolution pass as a deliberately deferred domain ([36](36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md)). Two guard-rails already apply: there is **no automatic Human substitution** — an Amorpho losing an encounter does not make the Human appear and continue the fight — and Human involvement remains subject to One Consciousness and to real physical location, with no teleportation implied (AMO-D028, AMO-D029, L23). Distinct from the *unattended* body during embodiment (AMO-Q041) and from physical rescue (AMO-Q046). Needs its own dedicated pass; nothing about Human combat, condition or protection is designed.
...
*Refined 2026-09-23 ([34](34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md)):* entry into a manifestation whose loss is already committed is permitted in principle — doom does not close the gates, and the gates are unchanged (AMO-D116). Once the manifestation has ended, entry is impossible because there is no body, not because a rule forbids it (AMO-D118). Where inhabitability actually lapses during terminal progression is shared with AMO-Q112.
...
*Refined 2026-09-23 ([35](35_COMBAT_PROTECTION_MANIFESTATION_BODY_DAMAGE_AND_BIOLOGICAL_PERSISTENCE_V0.md)):* equipment gains an explicit architectural purpose — intercepting hostile effects before they become biological body damage (AMO-D122) — and may itself be depleted or damaged. The established rule is unchanged: worn protection helps the animated body and does not become rooted-plant environmental protection on rooting. No slot, item, durability or crafting model follows.
...
*Refined 2026-09-23 ([42](42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md)):* controlled-environment value is **lifecycle-dependent**: a greenhouse may extend real opportunity for an individual still capable of active growth and cannot cancel a dormancy requirement, and factors it does not actually modify stay limiting (AMO-D146). Its usefulness is World modification × individual biology, never a universal effect.
...
*Refined 2026-09-23 ([38](38_END_TO_END_COMBAT_ENCOUNTER_AND_BIOLOGICAL_CONTINUITY_TRACE_V0.md)):* a fourth case sits beside the three tolerances and must not be confused with them: an individual **carried inside its own embodied manifestation** has its ordinary biology suspended, so travel accrues no rooted environmental consequence, while an exposed or excavated Tuber carried by a rescuer remains biologically live (AMO-D084, AMO-D129, AMO-D093, AMO-Q117). Traversal tolerance governs the animated body; equipment protecting it still never protects the rooted plant (AMO-Q048).
...
**Status:** OPEN · **World-time independence resolved 2026-09-23 → AMO-D145** · **Constraints:** AMO-D046, AMO-D049
...
*Refined 2026-09-23 ([39](39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md)):* one interaction is deliberately left to this question and AMO-Q004: while an individual is inhabited its own biological progression is suspended while the World continues, so how external world time relates to a paused individual's remaining productive opportunity is undecided (AMO-D084, AMO-D136). No position was taken, and both rules stand as written.
*Refined 2026-09-23 ([42](42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md)):* one part is **no longer open**: whether World seasonal time matters while an individual's biology is paused. It does — embodiment freezes the plant, not the planet, and suitable opportunity can pass unused (AMO-D145, L64). This question keeps time scale interaction, granularity, how quickly local suitability changes, and update frequency for unobserved individuals.
...
**Status:** OPEN · **Qualitative productive-return ontology resolved 2026-09-23 → AMO-D135–AMO-D138** · **Constraints:** AMO-D091, AMO-D081
...
*Refined 2026-09-22 ([25_TUBER_FUNDED_MANIFESTATION_AND_REPLACEMENT_ROUTING_V0.md](25_TUBER_FUNDED_MANIFESTATION_AND_REPLACEMENT_ROUTING_V0.md)):* replacement valuation depends on **Remaining Productive Opportunity** after emergence time as well as the replacement's later capacity. Opportunity informs biological routing but is not a season-percentage rule or player countdown. This question retains productivity integration; AMO-Q101 owns route eligibility and autonomous biological choice.
*Refined 2026-09-22 ([30_EMERGENCE_INVESTMENT_AND_FULL_DEPLOYMENT_ACCOUNTING_BOUNDARY_V0.md](30_EMERGENCE_INVESTMENT_AND_FULL_DEPLOYMENT_ACCOUNTING_BOUNDARY_V0.md)):* mature Leaf productivity accounting begins at Full Deployment; a developing Leaf's limited possible activity is not treated as the full active-phase return in v0. After failure, remaining opportunity is distinct from sunk Tuber investment and may affect whether another attempt is worthwhile. No integration formula is chosen.
...
*Refined 2026-09-23 ([39](39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md)):* the **qualitative ontology is resolved** (AMO-D135–AMO-D138): Active Leaf Productive Return is biological work performed during rooted active life, Functional Capacity is a non-linear input rather than the return, return depends jointly on capacity, Fit, condition, actual rooted time and Remaining Productive Opportunity, embodiment suspends it, realized return is never erased, and possible persistent destinations are named without allocation. **Still open, and this question's whole remaining substance:** representation of capacity and opportunity, rates, how return integrates over a phase into a persistent outcome, the exact capacity relationship, Fit weighting, reserve allocation, maturity mapping and seasonal timing. No balance, currency or single Tuber score may be introduced (AMO-D135).
*Refined 2026-09-23 ([40](40_ROOTED_MATURE_LEAF_RECOVERY_CEILING_AND_COMPENSATORY_REMODELING_V0.md)):* recovered function feeds productive return, and the two axes stay independent: **recovery potential** and **Remaining Productive Opportunity** may be high or low in any combination, so a biologically successful rehabilitation can still be seasonally worth little (AMO-D141). Recovery restores future capability and never past opportunity (AMO-D137). Nothing quantitative changes here.
*Refined 2026-09-23 ([42](42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md)):* Remaining Productive Opportunity must now reflect **two** qualitative constraints without merging into one season timer: external opportunity remaining in reachable World conditions, and biological opportunity remaining in the individual's own lifecycle (AMO-D146). Productive Return requires actual rooted biological time while suitable opportunity exists, and elapsed World time spent embodied can never be converted afterwards (AMO-D145).
...
*Refined 2026-09-23 ([43](43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md)):* direct Tuber harm remains the clearest pathology pathway and may occur with capacity fully intact (AMO-D090, AMO-D148). Future causes of direct persistent harm are this question's and AMO-Q105's to explore when needed; none is canonised here, and no species vulnerability is assumed (AMO-D024).

### AMO-Q118 — Where a neutral outcome becomes actual loss
**Status:** OPEN · **Qualitative depletion → persistent-harm ontology resolved 2026-09-23 → AMO-D148–AMO-D151** · **Constraints:** AMO-D092, AMO-D056
...
*Refined 2026-09-22 ([30_EMERGENCE_INVESTMENT_AND_FULL_DEPLOYMENT_ACCOUNTING_BOUNDARY_V0.md](30_EMERGENCE_INVESTMENT_AND_FULL_DEPLOYMENT_ACCOUNTING_BOUNDARY_V0.md)):* even a late failed Emergence can leave substantial sunk investment, depletion and no mature return without automatic pathology or Developmental Maturity regression. This question still owns when those conditions become actual harmful persistent loss (AMO-D109, AMO-D111).
*Refined 2026-09-23 ([32](32_IMPERFECTLY_DEPLOYED_MATURE_LEAF_STABILIZATION_OR_DECLINE_V0.md)):* existing in an imperfectly deployed state is not itself persistent loss, and imperfection creates no standing per-moment Tuber debit. Sunk construction and reduced mature manifestation quality are two consequences of one developmental history, not one charge applied twice (AMO-D109, AMO-D111). This question still owns whether an active phase spent at reduced function crosses into actual harmful persistent loss.
*Refined 2026-09-23 ([39](39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md)):* this question now receives an explicit seam: **when does ordinary depletion, missed gain or insufficient Productive Return become actual persistent harmful loss?** Fixed before it is answered — insufficient return is not pathology, return and pathology are orthogonal and may not become one score, direct Tuber harm bypasses productive accounting, and lost opportunity is never regression (AMO-D138, AMO-D082, AMO-D092). It must also keep replenishment distinct from net gain: an individual recovering construction cost may show no net gain while genuinely improving.
*Refined 2026-09-23 ([43](43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md)):* the **qualitative ontology is resolved** (AMO-D148–AMO-D151): ordinary depletion is defined positively, legitimate expenditure, missed gain and insufficient return are not pathology, crossing the boundary changes what happened rather than a value, cumulative strain crosses only where persistence itself degrades, and Core Viability is a separate dimension. **Still open, and this question's whole remaining substance:** representation, exact persistent-harm criteria, cumulative integration, severity, susceptibility, species and individual variation, and any quantitative mapping from adverse history to outcome. It may not answer by inferring harm from how low capacity is.
...
*Refined 2026-09-22 ([29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md](29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md)):* Full Leaf or Bloom Deployment is now required before normal inhabitation can become possible (AMO-D107), but it does not set Readiness to a particular value. This question owns the exact post-deployment Readiness condition and recovery path.
*Refined 2026-09-23 ([32](32_IMPERFECTLY_DEPLOYED_MATURE_LEAF_STABILIZATION_OR_DECLINE_V0.md)):* an imperfectly deployed mature manifestation is neither automatically Astral Ready nor automatically unready. This question owns how a compromised mature state relates to the readiness condition, with no perfection requirement implied in either direction (AMO-D107, AMO-D113).
*Refined 2026-09-23 ([33](33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md)):* a Leaf in committed terminal decline may remain temporarily inhabitable while it physically exists; doom is not a magical disconnect, and terminal Collapse ends normal Leaf inhabitation because no manifestation remains (AMO-D116). This question owns where in the terminal period readiness or inhabitability actually ends. Embodiment pauses biological progression and Readiness returns only through rooted life, so no exit-and-re-enter loop can stall the loss (AMO-D084, AMO-D086, L50).
*Refined 2026-09-23 ([34](34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md)):* a committed terminal manifestation may still be inhabited while it exists, and continuous embodiment suspends its terminal progression (AMO-D116, AMO-D117). This question owns where inhabitability or readiness may end during terminal progression — and it **must not be turned into a forced-exit device**: no readiness decay may be introduced merely to end a long terminal embodiment. Whether readiness depletes while embodied at all is still this question's to answer, and it is currently the only accepted mechanism that could bound a very long embodiment in practice.
...
*Refined 2026-09-23 ([33](33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md)):* a further case belongs here: an embodiment already in progress when the inhabited Leaf's manifestation ends at terminal Collapse (AMO-D115, AMO-D116). It must respect the biology pause — the terminal trajectory does not advance while inhabited — and must not turn a magical-layer outcome into new biological harm (AMO-D084, L49).
*Refined 2026-09-23 ([34](34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md)):* also owns the involuntary case: an embodiment already under way when the inhabited manifestation **ceases to exist**. The destination is fixed — the consciousness returns to the persistent human body, with no shell and no free-floating astral form (AMO-D118, L57) — while circumstances, presentation and any further consequence remain open. It must not import a biological outcome for the vanished manifestation (AMO-D119).
*Refined 2026-09-23 ([36](36_COMBAT_RESOLUTION_SURRENDER_ESCAPE_AND_WITHDRAWAL_V0.md)):* voluntary and involuntary ends are now distinct: surrender, withdrawal, escape and objective resolution end an **encounter** without ending embodiment (AMO-D126). This question still owns whether any combat-state failure forces exit at all, and what such a forced return does — it may not assume that losing an encounter expels the Warden or roots the plant.
...
*Refined 2026-09-22 ([29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md](29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md)):* a Leaf or Bloom can be biologically visible during Emergence while still non-inhabitable. The exact Signal behaviour through sheath formation, surface emergence, Full Deployment and the replacement handoff remains open; Signal alone never grants entry (AMO-D107).
...
*Refined 2026-09-23 ([43](43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md)):* the crossing's **ontology** is now specified: depletion and harm are different biological facts, not neighbouring values, and the indirect pathway requires actual degradation of persistent capability beyond unreplenished depletion (AMO-D149). This question keeps the crossing's mechanics and susceptibility, and must remain compatible with a dangerously depleted but entirely intact Tuber (AMO-D148).
...
*Refined 2026-09-23 ([43](43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md)):* this question owns **persistent-recovery dynamics** for actual harm, which is now explicitly distinct from ordinary replenishment of capacity (AMO-D150). Fixed before it is answered: neither a new manifestation, dormancy nor elapsed time resets persistent harm, and persistent does not mean permanent (AMO-D149, AMO-D075).
*Refined 2026-09-23 ([44](44_FULL_BIOLOGICAL_YEAR_PERSISTENT_STATE_INTEGRATION_TRACE_V1.md)):* the full-cycle integration trace leans on this question at one point: a dormant period restores **Astral Readiness only**, and awards, refills or clears nothing biological (AMO-D083, AMO-D086, AMO-D145). What a dormant period actually does to persistent capacity and condition — assist recovery, cost maintenance, or neither — remains this question's, with AMO-Q073 for the condition variables. No dormant refill may be assumed.
...
*Refined 2026-09-22 ([25_TUBER_FUNDED_MANIFESTATION_AND_REPLACEMENT_ROUTING_V0.md](25_TUBER_FUNDED_MANIFESTATION_AND_REPLACEMENT_ROUTING_V0.md)):* repeated microdamage and scarring remain with the current Leaf while useful function and viability persist (AMO-D096). This question owns the prospect of stabilization or compensation **before** functional collapse is declared; scar count alone never triggers replacement. The functional-collapse criterion belongs to AMO-Q101.
*Refined 2026-09-22 ([31_DAMAGED_EMERGENCE_TO_IMPERFECT_DEPLOYMENT_V0.md](31_DAMAGED_EMERGENCE_TO_IMPERFECT_DEPLOYMENT_V0.md)):* a Leaf that deploys imperfectly enters this **mature** recovery domain with the structure and function it actually developed (AMO-D113). Compensation during Emergence belongs to AMO-Q086/AMO-Q101; Full Deployment does not itself repair the Leaf. This question still owns subsequent same-manifestation recovery.
*Refined 2026-09-23 ([32](32_IMPERFECTLY_DEPLOYED_MATURE_LEAF_STABILIZATION_OR_DECLINE_V0.md)):* this question accepts an **imperfectly deployed** mature Leaf as a valid starting state, and owns whether developmental damage leaves that manifestation a lower **attainable functional ceiling** — recovery toward what this Leaf can attain rather than toward a hypothetical undamaged original (AMO-D094). It also owns whether stabilization, scarring and compensation act on inherited developmental defects as they do on later injury, and how current biological condition, including persistent Tuber state, influences mature recovery capacity without returning damage ownership to the Tuber (AMO-D111).
*Refined 2026-09-23 ([33](33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md)):* recovery and stabilization operate **while the current Leaf remains viable**. This question owns whether stabilization can still avert Collapse Commitment from a given state; after commitment there is no recovery path back to active viability for that Leaf (AMO-D115), so favorable later conditions may change the terminal period's course but never its outcome.
*Refined 2026-09-23 ([35](35_COMBAT_PROTECTION_MANIFESTATION_BODY_DAMAGE_AND_BIOLOGICAL_PERSISTENCE_V0.md)):* damage acquired while the manifestation was inhabited is ordinary mature damage for this question: recovery starts once rooted biological life resumes, from the actual condition, with no combat-specific repair path and no in-embodiment biological healing (AMO-D123). A still-viable damaged manifestation may be withdrawn before Collapse and rehabilitated here.
*Refined 2026-09-23 ([40](40_ROOTED_MATURE_LEAF_RECOVERY_CEILING_AND_COMPENSATORY_REMODELING_V0.md)):* the **recovery architecture is now specified** (AMO-D139–AMO-D141): Structural Stabilization, Scarring and Compensatory Remodeling, substantial Functional Recovery, and a qualitative **Recovery Ceiling** bounding it. This question now owns: how the ceiling is represented, how damage changes it, **whether anything can raise a reduced ceiling within the same phase** (the v0 direction is that rehabilitation moves current function toward what surviving biology supports and does not restore lost ceiling through time), rates and extent, environmental and condition dependence, and **any biological demand rehabilitation itself makes** — left open rather than denied, with no healing currency permitted.
*Refined 2026-09-23 ([42](42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md)):* rehabilitation waits for rooting while the World does not wait, so Recovery Ceiling and Remaining Productive Opportunity move independently: a late rehabilitation may succeed biologically while little useful opportunity remains (AMO-D141, AMO-D145). No formula relates them.
...
*Refined 2026-09-23 ([39](39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md)):* Tuber Core Viability now has an accounting explanation: it moves with accumulated Productive Return, so it may arrive well before a successful season and can fail to arrive at all if an early-inhabited individual never rebuilds (AMO-D131, AMO-D135, AMO-D136). It remains a **survival boundary rather than a goal** — viable is not healthy, well-reserved or mature — and this question still owns the criterion itself.
*Refined 2026-09-23 ([41](41_BLOOM_EMBODIMENT_CORE_SECURITY_AND_DESTRUCTION_VALUE_V0.md)):* a Bloom raises confidence that a viable core exists without guaranteeing it, so the viability criterion must remain able to return **non-viable** for a manifestation that began from substantial capability — after heavy Programmed Draw, prior pathology, extraordinary depletion or direct core injury (AMO-D144, AMO-D087, AMO-D090). Capability evidence and salvageability verdict are separate things.
*Refined 2026-09-23 ([43](43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md)):* Core Viability and pathology are **separate dimensions**: a core may be non-viable with nothing ever harmed, or pathological while still viable, and the verdict does not reveal which pathway produced the vulnerability (AMO-D151). The criterion must therefore not be defined in a way that implies injury from depletion alone.
...
*Refined 2026-09-23 ([43](43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md)):* this is the **single broad owner** of any future persistent repair, care or pathology-management layer — noticing, diagnosis, intervention, treatment and improvement of persistent condition. Possible future causes such as pathogens, parasites, environmental or physical injury and cumulative stress are **examples for later research only**, and **no per-cause, per-disease, per-symptom or per-treatment question may be created** (AMO-D149, AMO-D150). Persistent pathology is a deliberately lower-priority future layer; the boundary is what the architecture needs now.
...
*Refined 2026-09-23 ([39](39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md)):* Productive Return may contribute to development only through the existing chain `Fit → opportunity → condition/reserves/growth → development`, never as points, levels or activity rewards (AMO-D081, AMO-D135, L47). Any future mapping from seasonal biological success to maturity belongs here, and it may not shortcut that chain.
*Refined 2026-09-23 ([43](43_ORDINARY_DEPLETION_TO_PERSISTENT_HARM_BOUNDARY_V0.md)):* pathology does not regress maturity, and a further distinction is now recorded: a harmed or severely depleted individual may be developmentally mature yet unable to **express** that maturity (AMO-D149, AMO-D082). Any future representation must keep development, available capacity and persistent harm as distinct facts rather than one condition value.
...
*Refined 2026-09-22 ([25_TUBER_FUNDED_MANIFESTATION_AND_REPLACEMENT_ROUTING_V0.md](25_TUBER_FUNDED_MANIFESTATION_AND_REPLACEMENT_ROUTING_V0.md)):* current Tuber state constrains the biological scale of primary and replacement Leafs (AMO-D095). A replacement is generally expected to be reduced after prior investment and lost time, but the species-shaped scale relationship and exceptions remain open; neither size nor maturity directly sets combat power (L5, AMO-Q109).
*Refined 2026-09-22 ([29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md](29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md)):* Full Deployment means complete for the current manifestation, including a reduced Replacement Leaf. How its reduced scale is derived remains here with AMO-Q084; size is separate from deployment completion.
*Refined 2026-09-23 ([42](42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md)):* species interpretation may eventually include lifecycle strategy — dormancy dependence, active-growth persistence, growth tempo — supplied as approved input only if the game demonstrably needs it, with no column added and no real species assigned here (AMO-D147, AMO-D024, AMO-D025).
...
*Refined 2026-09-23 ([40](40_ROOTED_MATURE_LEAF_RECOVERY_CEILING_AND_COMPENSATORY_REMODELING_V0.md)):* a presentation extension point is recorded without being designed: compensated tissue may later be made visually legible — reinforced surviving structure, more vigorous remaining functional regions — and distinguishable from fresh injury, terminal yellowing and pristine structure (AMO-D139). No appearance is canonised, and the existing asymmetry holds: scars are history, and appearance reports neither current capacity nor the ceiling (AMO-D134, AMO-D140).
*Refined 2026-09-23 ([41](41_BLOOM_EMBODIMENT_CORE_SECURITY_AND_DESTRUCTION_VALUE_V0.md)):* manifestation **type** is visible by nature, so the inference a Bloom supports emerges from the form itself and needs no indicator: no icon, readout, rarity marker or scan may announce what is inside (AMO-D142). This question still owns what a player perceives, including that a Bloom's own condition reveals nothing exact about the core.
...
*Refined 2026-09-23 ([41](41_BLOOM_EMBODIMENT_CORE_SECURITY_AND_DESTRUCTION_VALUE_V0.md)):* this question owns **how much persistent biological capability Bloom actually requires**, beyond the flowering-maturity gate itself (AMO-D078). One consequence is already fixed: whatever the requirement turns out to be, it must remain meaningful enough that an existing Bloom is genuine evidence of substantial capability, so an individual barely able to persist after paying for a Leaf may not produce an expensive Bloom as though its condition were irrelevant (AMO-D142).
...
**Status:** OPEN · **Base topology resolved 2026-09-21 → AMO-D070, AMO-D071; replacement route traced 2026-09-22 → AMO-D096** · **Constraints:** AMO-D024, AMO-D059, AMO-D070, AMO-D094, AMO-D096
...
*Refined 2026-09-22 ([25_TUBER_FUNDED_MANIFESTATION_AND_REPLACEMENT_ROUTING_V0.md](25_TUBER_FUNDED_MANIFESTATION_AND_REPLACEMENT_ROUTING_V0.md)):* the preceding topology alternative is now narrowed: **reuse Emergence in a replacement context**, `Active Leaf → Emergence → Active Leaf`, without a new state or annual reset (AMO-D096). The old Leaf's presence/function during handoff, repeated attempts, species scope, timing and reduced form remain open. Reusing the state does not assign a replacement's astral window or transfer the Warden (AMO-Q085, AMO-Q112, AMO-Q115).
*Refined 2026-09-22 ([29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md](29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md)):* Primary Leaf, Replacement Leaf and Bloom now share high-level Manifestation Emergence in the existing state (AMO-D106). This question keeps exact duration, optional sub-phases, manifestation-specific variation, old/new overlap, Full Deployment criteria and how a failed attempt leaves Emergence. No separate instant Bloom route is implied.
*Refined 2026-09-22 ([30_EMERGENCE_INVESTMENT_AND_FULL_DEPLOYMENT_ACCOUNTING_BOUNDARY_V0.md](30_EMERGENCE_INVESTMENT_AND_FULL_DEPLOYMENT_ACCOUNTING_BOUNDARY_V0.md)):* Full Deployment is also the hard accounting and damage-domain handoff for primary Leaf, Replacement Leaf and Bloom (AMO-D111). Exact biological completion criteria, repeated-attempt topology and any manifestation-specific exception remain open; no fractional ownership stage is introduced.
*Refined 2026-09-22 ([31_DAMAGED_EMERGENCE_TO_IMPERFECT_DEPLOYMENT_V0.md](31_DAMAGED_EMERGENCE_TO_IMPERFECT_DEPLOYMENT_V0.md)):* imperfect construction can still cross Full Deployment (AMO-D112, AMO-D113). This question keeps the exact biological sufficiency criterion for a damaged Leaf or Bloom, and how an irreversibly arrested attempt leaves Emergence; no additional state is required by the trace.
*Refined 2026-09-23 ([33](33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md)):* also owns how long a committed terminal Leaf remains physically present, whether its terminal period can overlap a Replacement Emergence, and what becomes of physical remains after the manifestation ends. Fixed: no collapsed-Leaf manifestation, shell or inhabitable remnant persists as an actor, and routing proceeds from the Tuber (AMO-D115).
*Refined 2026-09-23 ([42](42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md)):* species lifecycle **strategy** now has a home in the topology's parameterisation: whether prolonged active growth is possible, whether substantial dormancy is normally required, and how readily activity resumes may differ by species, while the individual always owns its current state (AMO-D147). Burst-seasonal and extended-growth are design space only, with no real species assigned and no species permission rules.

### AMO-Q101 — Life-cycle transition triggers
**Status:** OPEN · **Collapse boundary concept resolved 2026-09-23 → AMO-D114–AMO-D116** · **Constraints:** AMO-D035, AMO-D037, AMO-D070
...
*Refined 2026-09-22 ([25_TUBER_FUNDED_MANIFESTATION_AND_REPLACEMENT_ROUTING_V0.md](25_TUBER_FUNDED_MANIFESTATION_AND_REPLACEMENT_ROUTING_V0.md)):* owns the **functional-collapse criterion**, biological eligibility to continue/replace/retreat, resource and time requirements, autonomous selection policy when no player agency exists, and what happens after repeated damage to a replacement (AMO-D096, AMO-D097). Eligibility is not advisability: an affordable replacement can still waste remaining opportunity. No automatic replacement or unlimited refresh loop is allowed. AMO-Q084 owns route topology and old/new overlap; AMO-Q119 owns agency availability and player knowledge.
*Refined 2026-09-22 ([26_PLANT_AUTONOMY_ASTRAL_LEVERAGE_AND_ROUTING_V0.md](26_PLANT_AUTONOMY_ASTRAL_LEVERAGE_AND_ROUTING_V0.md)):* the autonomous policy's **objective** is now fixed — routing serves the individual's own long-term biological viability and future developmental and reproductive potential, from currently available state rather than foresight (AMO-D098). What this question still owns is the policy itself: how that objective is evaluated, which of the named input categories actually participate and how, whether tendency is expressed as probability, weighted propensity, deterministic utility or a hybrid, how much variability is appropriate, what information an individual may effectively use, and whether individual or lineage traits shift routing tendencies. Two constraints bind any answer: variability must be **biologically conditioned** — no state-independent split — and no AI technology is implied by the word *autonomous*. AMO-Q075 owns where randomness lives; AMO-Q119 owns Warden override.
*Refined 2026-09-22 ([28_ASTRAL_WINDOW_END_TO_END_TRACE_V0.md](28_ASTRAL_WINDOW_END_TO_END_TRACE_V0.md)):* the trace assumes qualitative feasibility and preference in distinct cases; it supplies no eligibility test or selection policy. Autonomous routing may execute during the Astral Window rather than wait for Deep Dormancy or Warden presence.
*Refined 2026-09-22 ([29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md](29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md)):* commitment starts ongoing biological expenditure, not guaranteed Full Deployment (AMO-D106, AMO-D108). Exact capacity distribution, environmental effects on success and pace, failure criteria and post-failure retreat routing remain open here; failure does not force an automatic retry.
*Refined 2026-09-22 ([30_EMERGENCE_INVESTMENT_AND_FULL_DEPLOYMENT_ACCOUNTING_BOUNDARY_V0.md](30_EMERGENCE_INVESTMENT_AND_FULL_DEPLOYMENT_ACCOUNTING_BOUNDARY_V0.md)):* Emergence investment accumulates with developmental commitment, so comparable late failure generally leaves more sunk cost than early failure (AMO-D109). This question owns whether accumulation is continuous or stage-shaped, which existing biological state dimensions represent funding, how current condition and reserves constrain a new attempt, and how sunk cost changes later route eligibility. No new currency, formula or retry count is set.
*Refined 2026-09-22 ([31_DAMAGED_EMERGENCE_TO_IMPERFECT_DEPLOYMENT_V0.md](31_DAMAGED_EMERGENCE_TO_IMPERFECT_DEPLOYMENT_V0.md)):* damage may lead to compensated continuation, compromised Full Deployment or arrest (AMO-D112). This question keeps the biological continuation/failure test, how Fit and current condition affect developmental compensation, and post-failure routing and later eligibility. No event severity or developmental timing alone mandates a route.
*Refined 2026-09-23 ([32](32_IMPERFECTLY_DEPLOYED_MATURE_LEAF_STABILIZATION_OR_DECLINE_V0.md)):* the functional-collapse criterion must be definable for a Leaf that **began** mature life impaired, so it cannot be expressed as a fall from a healthy mature baseline. Imperfect Full Deployment is not itself collapse, a replacement trigger or a reason for premature retreat (AMO-D113); only sufficiently declined mature function makes routing relevant, and a stabilized compromised Leaf may never reach that point.
*Refined 2026-09-23 ([33](33_MATURE_LEAF_FUNCTIONAL_COLLAPSE_BOUNDARY_V0.md)):* the **qualitative** collapse boundary is now settled (AMO-D114–AMO-D116): routing begins only when the current Leaf can no longer meaningfully serve as the active manifestation, judged from current capability; commitment is irreversible; the route is taken from the persistent Tuber. **Still open:** the exact viability criterion, how confirmed Collapse is distinguished from transient functional suppression, any confirmation or hysteresis behaviour, the terminal period's course, eligibility, timing and autonomous policy. No threshold, rate or duration was chosen.
*Refined 2026-09-23 ([42](42_WORLD_TIME_SEASONAL_OPPORTUNITY_AND_EMBODIMENT_V0.md)):* this question also owns any **dormancy commitment boundary** implied by the new rule that relocation cannot reset an intrinsic lifecycle transition (AMO-D146). If the lifecycle model later names such a boundary it should be reused rather than duplicated, and environmental cues may influence when transitions develop without the environment becoming sovereign over the lifecycle (AMO-D035–AMO-D037).

### AMO-Q119 — Agency at biological routing points
**Status:** OPEN · **Constraints:** AMO-D009, AMO-D084, AMO-D097
When can a player influence a biological replacement-versus-retreat decision, and how does that choice reach the individual? Does current habitation, human proximity, Astral Signal, an Anchor or future cultivation infrastructure matter? What prognosis can the player reasonably know without seeing exact future conditions or costs?
*Notes:* Biology determines eligible routes first (AMO-D097); player desire cannot create Tuber capacity, and owning an individual does not imply instant remote control. An unattended rooted plant must route autonomously while the persistent World continues (AMO-Q101). Normal biology and replacement emergence are suspended during embodiment (AMO-D084), so any influence on a later rooted route must respect that boundary. No interface, remote command, perfect forecast or control entitlement is decided here. Astral access and signal remain AMO-Q085/AMO-Q115; human physical intervention and treatment remain AMO-Q105.
*Refined 2026-09-22 ([26_PLANT_AUTONOMY_ASTRAL_LEVERAGE_AND_ROUTING_V0.md](26_PLANT_AUTONOMY_ASTRAL_LEVERAGE_AND_ROUTING_V0.md)):* the **boundary is now settled**, in three layers — biological feasibility, the plant's autonomous preference, and a Warden override that selects only among feasible routes (AMO-D098, AMO-D100). Also settled: influence requires **direct astral presence**, which ownership, custody, Radar awareness, Astral Capacity and inhabiting another individual do not supply, and which occupies the one consciousness that embodiment occupies (AMO-D101); the opportunity exists only while the individual is reachable — the **Astral Window** — and Deep Dormancy ends it with no retroactive rewrite (AMO-D099); a compelled route carries the same biological cost as an autonomous one (L52). What remains open here: how presence is established and ended, whether it consumes or costs Astral Readiness (AMO-Q112), whether it counts as *inhabiting* for rules written about embodiment, what prognosis and state a player may reasonably know or be shown (no interface, radar detail or notification is designed — AMO-Q092, AMO-Q115, L14), the downstream consequences of forced emergence, and whether repeated forcing needs any limit beyond accumulated biological cost.
*Refined 2026-09-22 ([28_ASTRAL_WINDOW_END_TO_END_TRACE_V0.md](28_ASTRAL_WINDOW_END_TO_END_TRACE_V0.md)):* the Window provides possible access, not a held decision. Presence must reach a still-available routing opportunity; connection does not pause biology or recover a route already underway. The trace does not settle presence mechanics or player knowledge.
*Refined 2026-09-22 ([29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md](29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md)):* compelling Replacement does not transfer the Warden into the incomplete Leaf or require direct presence throughout Emergence. Whether strategic presence persists, ends or changes into limited awareness after commitment remains open here, with access and Signal owned by AMO-Q085/AMO-Q115.
*Refined 2026-09-23 ([34](34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md)):* a Warden returned to the human body because the inhabited manifestation ended gains **no** automatic strategic presence, control or priority at the routing point that follows; direct presence must be established under the ordinary rules and occupies the same single consciousness (AMO-D101, AMO-D118). Whether it can be established immediately after such a return is this question's to answer.

### AMO-Q120 — Route authorship and stored life-cycle history
**Status:** OPEN · **Constraints:** AMO-D011, AMO-D098, AMO-D101
Does persistent history record **who selected** a major biological route — the individual's own autonomous biology, or a Warden compelling a feasible alternative — and how much routing history is kept at all?
*Notes:* Nothing is implemented, and nothing depends on it yet: the biological outcome is identical either way, because a compelled route costs what an autonomous one costs (AMO-D100). It is recorded because provenance, lineage storytelling, player memory and later trade value are plausible consumers (AMO-D011, AMO-Q009), and because a history that keeps everything is as much a decision as one that keeps nothing. Any answer must avoid becoming a moral record: authorship is not an abuse log, and no happiness, consent or morality state may be introduced under it (AMO-D100). Relates to what a rooted individual does over time (AMO-Q077) and to persistence scope generally (AMO-Q012).
*Refined 2026-09-22 ([28_ASTRAL_WINDOW_END_TO_END_TRACE_V0.md](28_ASTRAL_WINDOW_END_TO_END_TRACE_V0.md)):* the trace distinguishes autonomous Replacement from Warden-compelled Replacement without requiring stored authorship. Whether a Warden who consciously agrees with the plant-preferred route counts as its author also remains open.
*Refined 2026-09-23 ([34](34_EMBODIMENT_ACROSS_TERMINAL_MANIFESTATION_COLLAPSE_V0.md)):* life-cycle history may later record that a manifestation entered committed terminal decline, that the Warden continued to use it, when biological progression was allowed to resume and where the individual was rooted (AMO-D117). Nothing is stored or designed here; the possibility is recorded because the terminal period makes authorship legible.
...
*Notes:* **Deep Dormancy is closed** (AMO-D060), and the post-manifestation Astral Window is an accepted strategic reachability period (AMO-D099). It provides no Tuber playability (AMO-D089). Dormancy entry should normally give visible biological warning rather than a bare *unavailable* (AMO-D059) — what that looks like is part of this question.
...
*Refined 2026-09-22 ([26_PLANT_AUTONOMY_ASTRAL_LEVERAGE_AND_ROUTING_V0.md](26_PLANT_AUTONOMY_ASTRAL_LEVERAGE_AND_ROUTING_V0.md)):* the transitional period in which a persistent Tuber without a viable playable manifestation stays reachable is now named the **Astral Window**, and its far end is fixed at Deep Dormancy (AMO-D099). It adds no new access value and no Tuber gameplay: reachable means a Warden may establish presence for a routing decision, never that the Tuber can be played (AMO-D089). This question keeps the boundaries — where the window opens after a manifestation ends, whether reachability outlasts inhabitability there, whether a collapse-driven entry differs from ordinary senescence, and how legible any of it should be.
*Refined 2026-09-22 ([28_ASTRAL_WINDOW_END_TO_END_TRACE_V0.md](28_ASTRAL_WINDOW_END_TO_END_TRACE_V0.md)):* after Leaf collapse, the reachable transitional Tuber can carry an intervention opportunity, but reachability need not mean a route remains unchosen. Deep Dormancy still ends access; how reachability changes once Replacement Emergence starts and the exact opening/closing boundaries remain open.
*Refined 2026-09-22 ([29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md](29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md)):* Emergence may carry transitional reachability, but neither a Tuber nor a developing Leaf or Bloom becomes normally inhabitable. Full Deployment is the biological prerequisite for normal manifestation entry (AMO-D107). This question still owns the exact access handoff from Astral Window to Emergence and at deployment.
...
*Refined 2026-09-21 ([17_LIFE_CYCLE_STATE_MACHINE_V0.md](17_LIFE_CYCLE_STATE_MACHINE_V0.md)):* each state now has its own manifestation, so a per-state integrity has somewhere to attach (AMO-D070). Phase-specific damage **outlasts embodiment** — exiting and re-entering repairs nothing, because damage belongs to the manifestation rather than the animation (AMO-D072). Earlier speculation about transitional Tuber gameplay is superseded by the fixed non-playability rule (AMO-D099).
...
*Refined 2026-09-22 ([29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md](29_REPLACEMENT_EMERGENCE_TO_ASTRAL_READINESS_V0.md)):* before Full Deployment, damage to a developing Leaf or Bloom belongs to emergence biology, not the mature manifestation damage model (AMO-D107). This question owns the difference and its possible contribution to failure; mature Leaf impairment/recovery starts after deployment, while mature Bloom damage remains its own domain.
*Refined 2026-09-22 ([30_EMERGENCE_INVESTMENT_AND_FULL_DEPLOYMENT_ACCOUNTING_BOUNDARY_V0.md](30_EMERGENCE_INVESTMENT_AND_FULL_DEPLOYMENT_ACCOUNTING_BOUNDARY_V0.md)):* developing-structure damage severity and already-funded Tuber investment are separate assessments (AMO-D110). This question owns partial continuation after damage, possible imperfect Full Deployment, and the biological difference between damage before and after the handoff. Appearance alone decides neither failure cost nor mature functional outcome.
*Refined 2026-09-22 ([31_DAMAGED_EMERGENCE_TO_IMPERFECT_DEPLOYMENT_V0.md](31_DAMAGED_EMERGENCE_TO_IMPERFECT_DEPLOYMENT_V0.md)):* the **outcome range** and handoff are settled (AMO-D112, AMO-D113): a developing Leaf or Bloom may compensate, deploy impaired or fail; an imperfectly deployed form starts mature life as actually built. Still open are developmental susceptibility by stage and manifestation type, repeated damage, sheath/path damage, compensation mechanisms, damage-to-continuation mapping, and how initial mature Structural Integrity and Functional Capacity or Bloom condition are derived. These are not mature recovery rules (AMO-Q103).
*Refined 2026-09-23 ([32](32_IMPERFECTLY_DEPLOYED_MATURE_LEAF_STABILIZATION_OR_DECLINE_V0.md)):* this question also owns how an inherited developmental impairment becomes the **initial** mature Structural Integrity and Leaf Functional Capacity, and whether such an impairment changes susceptibility to later mature events. The two axes stay separate from the first moment of mature life: an imperfectly deployed Leaf may begin with poor structure and useful function, or the reverse (AMO-D091, L51). Stabilization and recovery from that starting state belong to AMO-Q103.
*Refined 2026-09-23 ([40](40_ROOTED_MATURE_LEAF_RECOVERY_CEILING_AND_COMPENSATORY_REMODELING_V0.md)):* the structural-to-functional relationship this question owns must now support three distinct things — surviving Structural Integrity, current Functional Capacity and Recovery Ceiling — with none derived from the others and no proportional mapping from visible damage to any of them (AMO-D140, AMO-D141, L51). It must also accommodate that identical missing architecture can support very different current function depending on whether the impairment is fresh or stabilized and compensated.
...
*Refined 2026-09-22 ([25_TUBER_FUNDED_MANIFESTATION_AND_REPLACEMENT_ROUTING_V0.md](25_TUBER_FUNDED_MANIFESTATION_AND_REPLACEMENT_ROUTING_V0.md)):* after Leaf functional collapse, ordinary **Senescence** remains the conservation/early-retreat branch alongside eligible Replacement Emergence. It can be necessary when replacement is impossible, or plausible when replacement is possible but little productive opportunity remains. This does not define a retreat threshold, cost or player-facing name (AMO-Q101, AMO-Q119).
...
*Refined 2026-09-23 ([41](41_BLOOM_EMBODIMENT_CORE_SECURITY_AND_DESTRUCTION_VALUE_V0.md)):* Bloom is already strategically distinct **before** its content is designed: through its biological prerequisite, the core information its existence carries, and the stakes of its destruction (AMO-D142–AMO-D144). This question therefore need not carry the whole burden of differentiating Bloom from Leaf through capabilities and costs. Bloom-specific mature damage and recovery remain here with AMO-Q086; doc 40's recovery architecture is Leaf-scoped.
