...
1. **Answer AMO-Q106 — how Developmental Maturity is represented, grown and regressed.** It is the newest dimension and the one most other things now lean on: premature retreat's price, Bloom eligibility, Bloom manifestation scale and the fragment-collapse case all resolve through it. The regression rule is the delicate part — it must be able to cost a player years of cultivation without costing them the individual (AMO-D077).
