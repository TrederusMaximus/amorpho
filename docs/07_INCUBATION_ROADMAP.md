...
1. **Define where ordinary depletion becomes persistent harmful loss (AMO-Q118)** — the seam doc 39 hands over: what distinguishes a disappointing season, ordinary depletion and insufficient Productive Return from actual Pathological Tuber Impact, including whether accumulation across a season can cross that boundary, stated qualitatively with no threshold, proportion or rate (AMO-D092, AMO-D138, [39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md](39_ACTIVE_LEAF_PRODUCTIVE_RETURN_AND_PERSISTENT_TUBER_BENEFIT_V0.md), [21](21_PATHOLOGICAL_TUBER_IMPACT_V0.md)).
